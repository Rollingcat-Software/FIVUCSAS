...
- **Last verified**: 2026-03-28 — All services UP and healthy. Auth method fixes deployed. 304 unit + 276+ E2E tests. Embeddable auth widget implemented (verify-app, auth-js SDK, auth-react, OAuth 2.0).
