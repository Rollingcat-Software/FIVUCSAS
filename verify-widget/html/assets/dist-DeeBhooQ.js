...
`))}function qi(e){return pa(e,()=>e.createProgram(),`Unable to create WebGLProgram.`)}function Ji(e,t){if(z(e,()=>e.linkProgram(t)),!N().get(`ENGINE_COMPILE_ONLY`)&&e.getProgramParameter(t,e.LINK_STATUS)===!1)throw console.log(e.getProgramInfoLog(t)),Error(`Failed to link vertex and fragment shaders.`)}function Yi(e,t){if(z(e,()=>e.validateProgram(t)),e.getProgramParameter(t,e.VALIDATE_STATUS)===!1)throw console.log(e.getProgramInfoLog(t)),Error(`Shader program validation failed.`)}function Xi(e,t){let n=pa(e,()=>e.createBuffer(),`Unable to create WebGLBuffer`);return z(e,()=>e.bindBuffer(e.ARRAY_BUFFER,n)),z(e,()=>e.bufferData(e.ARRAY_BUFFER,t,e.STATIC_DRAW)),n}function Zi(e,t){let n=pa(e,()=>e.createBuffer(),`Unable to create WebGLBuffer`);return z(e,()=>e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,n)),z(e,()=>e.bufferData(e.ELEMENT_ARRAY_BUFFER,t,e.STATIC_DRAW)),n}function Qi(){return N().getNumber(`WEBGL_VERSION`)===2?1:4}function $i(e){return pa(e,()=>e.createTexture(),`Unable to create WebGLTexture.`)}function ea(e,t){let n=N().getNumber(`WEBGL_MAX_TEXTURE_SIZE`);if(e<=0||t<=0){let n=`[${e}x${t}]`;throw Error(`Requested texture size `+n+` is invalid.`)}if(e>n||t>n){let r=`[${e}x${t}]`,i=`[${n}x${n}]`;throw Error(`Requested texture size `+r+` greater than WebGL maximum on this browser / GPU `+i+`.`)}}function ta(e){return pa(e,()=>e.createFramebuffer(),`Unable to create WebGLFramebuffer.`)}function na(e,t,n,r,i,a,o){let s=e.getAttribLocation(t,n);return s===-1?!1:(z(e,()=>e.bindBuffer(e.ARRAY_BUFFER,r)),z(e,()=>e.vertexAttribPointer(s,i,e.FLOAT,!1,a,o)),z(e,()=>e.enableVertexAttribArray(s)),!0)}function ra(e,t,n){ma(e,n),z(e,()=>e.activeTexture(e.TEXTURE0+n)),z(e,()=>e.bindTexture(e.TEXTURE_2D,t))}function ia(e,t){ma(e,t),z(e,()=>e.activeTexture(e.TEXTURE0+t)),z(e,()=>e.bindTexture(e.TEXTURE_2D,null))}function aa(e,t,n){return pa(e,()=>e.getUniformLocation(t,n),`uniform "`+n+`" not present in program.`)}function oa(e,t,n){return e.getUniformLocation(t,n)}function sa(e,t,n,r){z(e,()=>ra(e,t,r)),z(e,()=>e.uniform1i(n,r))}function ca(e){z(e,()=>e.bindFramebuffer(e.FRAMEBUFFER,null)),z(e,()=>e.viewport(0,0,e.canvas.width,e.canvas.height)),z(e,()=>e.scissor(0,0,e.canvas.width,e.canvas.height))}function la(e,t,n){z(e,()=>e.bindFramebuffer(e.FRAMEBUFFER,n)),z(e,()=>e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,t,0))}function ua(e,t){z(e,()=>e.bindFramebuffer(e.FRAMEBUFFER,t)),z(e,()=>e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,null,0))}function da(e){let t=e.checkFramebufferStatus(e.FRAMEBUFFER);if(t!==e.FRAMEBUFFER_COMPLETE)throw Error(`Error binding framebuffer: `+fa(e,t))}function fa(e,t){switch(t){case e.FRAMEBUFFER_INCOMPLETE_ATTACHMENT:return`FRAMEBUFFER_INCOMPLETE_ATTACHMENT`;case e.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:return`FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT`;case e.FRAMEBUFFER_INCOMPLETE_DIMENSIONS:return`FRAMEBUFFER_INCOMPLETE_DIMENSIONS`;case e.FRAMEBUFFER_UNSUPPORTED:return`FRAMEBUFFER_UNSUPPORTED`;default:return`unknown error ${t}`}}function pa(e,t,n){let r=z(e,()=>t());if(r==null)throw Error(n);return r}function ma(e,t){let n=e.MAX_COMBINED_TEXTURE_IMAGE_UNITS-1,r=t+e.TEXTURE0;if(r<e.TEXTURE0||r>n){let e=`[gl.TEXTURE0, gl.TEXTURE${n}]`;throw Error(`textureUnit must be in ${e}.`)}}function ha(e,t=2){return T(e.slice(0,e.length-t))}function ga(e){if(e.length===0)throw Error(`Cannot get rows and columns of an empty shape array.`);return[e.length>1?e[e.length-2]:1,e[e.length-1]]}function _a(e){let t=[1,1,1];return e.length===0||e.length===1&&e[0]===1||(t=[ha(e),...ga(e)]),t}function va(e,t=!1){let n=N().getNumber(`WEBGL_MAX_TEXTURE_SIZE`),r=N().getNumber(`WEBGL_MAX_SIZE_FOR_NARROW_TEXTURE`);r===1/0&&N().getBool(`WEBGL_AUTO_SQUARIFY_NARROW_TEXTURE_SHAPE`)&&(r=n/2),t&&(n*=2,r*=2,e=e.map((t,n)=>n>=e.length-2?ri(e[n]):e[n]),e.length===1&&(e=[2,e[0]])),e.length!==2&&(e=li(e).newShape);let i=T(e),a=null;e.length<=1&&i<=n?a=[1,i]:e.length===2&&e[0]<=n&&e[1]<=n?a=e:e.length===3&&e[0]*e[1]<=n&&e[2]<=n?a=[e[0]*e[1],e[2]]:e.length===3&&e[0]<=n&&e[1]*e[2]<=n?a=[e[0],e[1]*e[2]]:e.length===4&&e[0]*e[1]*e[2]<=n&&e[3]<=n?a=[e[0]*e[1]*e[2],e[3]]:e.length===4&&e[0]<=n&&e[1]*e[2]*e[3]<=n&&(a=[e[0],e[1]*e[2]*e[3]]);let o=a!=null&&Math.max(...a)>r&&Math.min(...a)<=(t?2:1)&&Math.min(...a)>0;if(a==null||o)if(t){let t=ha(e),n=2,r=2;e.length&&([n,r]=ga(e)),i=n/2*t*(r/2),a=y(i).map(e=>e*2)}else a=y(i);return a}function ya(e){return e%2==0}function ba(e,t){if(e=e.slice(-2),t=t.slice(-2),O(e,t)||!e.length||!t.length||e[0]===0||e[1]===0||t[0]===0||t[1]===0)return!0;if(e.length!==t.length){let n=e[e.length-1],r=t[t.length-1];if(n===r||ya(n)&&ya(r)&&(e[0]===1||t[0]===1))return!0}return e[1]===t[1]&&ya(e[0])&&ya(t[0])}var xa,Sa;function Ca(e){if(xa==null){let t=I(e);xa=t.getParameter(t.MAX_TEXTURE_SIZE)}return xa}function wa(){xa=null}function Ta(){Sa=null}function Ea(e){if(Sa==null){let t=I(e);Sa=t.getParameter(t.MAX_TEXTURE_IMAGE_UNITS)}return Math.min(16,Sa)}function Da(e){if(e===0)return 0;let t,n=I(e);return t=B(n,`EXT_disjoint_timer_query_webgl2`)&&e===2?2:B(n,`EXT_disjoint_timer_query`)?1:0,t}function B(e,t){return e.getExtension(t)!=null}function Oa(e){try{if(I(e)!=null)return!0}catch(e){return console.log(`Error when getting WebGL context: `,e),!1}return!1}function ka(e){if(e===0)return!1;let t=I(e);if(e===1){if(!B(t,`OES_texture_float`))return!1}else if(!B(t,`EXT_color_buffer_float`))return!1;return ja(t)}function Aa(e){if(e===0)return!1;let t=I(e);if(e===1){if(!B(t,`OES_texture_float`)||!B(t,`WEBGL_color_buffer_float`))return!1}else{if(B(t,`EXT_color_buffer_float`))return ja(t);let e=`EXT_color_buffer_half_float`;return B(t,e)?Ma(t,t.getExtension(e)):!1}return ja(t)}function ja(e){let t=Fi(e),n=e.createTexture();e.bindTexture(e.TEXTURE_2D,n),e.texImage2D(e.TEXTURE_2D,0,t.internalFormatFloat,1,1,0,t.textureFormatFloat,t.textureTypeFloat,null);let r=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,r),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,n,0);let i=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;return e.bindTexture(e.TEXTURE_2D,null),e.bindFramebuffer(e.FRAMEBUFFER,null),e.deleteTexture(n),e.deleteFramebuffer(r),i}function Ma(e,t){let n=Fi(e,t),r=e.createTexture();e.bindTexture(e.TEXTURE_2D,r),e.texImage2D(e.TEXTURE_2D,0,n.internalFormatHalfFloat,1,1,0,n.textureFormatFloat,n.textureTypeHalfFloat,null);let i=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,i),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,r,0);let a=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;return e.bindTexture(e.TEXTURE_2D,null),e.bindFramebuffer(e.FRAMEBUFFER,null),e.deleteTexture(r),e.deleteFramebuffer(i),a}function Na(e){return e===2?I(e).fenceSync!=null:!1}function Pa(e,t){Array.isArray(e)||(e=[e]),e.forEach(e=>{e!=null&&A(e.dtype!==`complex64`,()=>`${t} does not support complex64 tensors in the WebGL backend.`)})}var V=N();V.registerFlag(`HAS_WEBGL`,()=>V.getNumber(`WEBGL_VERSION`)>0),V.registerFlag(`WEBGL_VERSION`,()=>Oa(2)?2:Oa(1)?1:0),V.registerFlag(`WEBGL_CHECK_NUMERICAL_PROBLEMS`,()=>!1),V.registerFlag(`WEBGL_BUFFER_SUPPORTED`,()=>V.get(`WEBGL_VERSION`)===2),V.registerFlag(`WEBGL_CPU_FORWARD`,()=>!0),V.registerFlag(`WEBGL_FORCE_F16_TEXTURES`,()=>!1),V.registerFlag(`WEBGL_PACK`,()=>V.getBool(`HAS_WEBGL`)),V.registerFlag(`WEBGL_PACK_NORMALIZATION`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_CLIP`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_DEPTHWISECONV`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_BINARY_OPERATIONS`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_UNARY_OPERATIONS`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_ARRAY_OPERATIONS`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_IMAGE_OPERATIONS`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_REDUCE`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_LAZILY_UNPACK`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_CONV_IM2COL`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_PACK_CONV2DTRANSPOSE`,()=>V.getBool(`WEBGL_PACK`)),V.registerFlag(`WEBGL_MAX_TEXTURE_SIZE`,()=>Ca(V.getNumber(`WEBGL_VERSION`))),V.registerFlag(`WEBGL_MAX_TEXTURES_IN_SHADER`,()=>Ea(V.getNumber(`WEBGL_VERSION`))),V.registerFlag(`WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION`,()=>{let e=V.getNumber(`WEBGL_VERSION`);return e===0?0:Da(e)}),V.registerFlag(`WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE`,()=>V.getNumber(`WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION`)>0&&!Ye()),V.registerFlag(`WEBGL_RENDER_FLOAT32_CAPABLE`,()=>ka(V.getNumber(`WEBGL_VERSION`))),V.registerFlag(`WEBGL_RENDER_FLOAT32_ENABLED`,()=>V.getBool(`WEBGL_FORCE_F16_TEXTURES`)?!1:V.getBool(`WEBGL_RENDER_FLOAT32_CAPABLE`)),V.registerFlag(`WEBGL_DOWNLOAD_FLOAT_ENABLED`,()=>Aa(V.getNumber(`WEBGL_VERSION`))),V.registerFlag(`WEBGL_FENCE_API_ENABLED`,()=>Na(V.getNumber(`WEBGL_VERSION`))),V.registerFlag(`WEBGL_SIZE_UPLOAD_UNIFORM`,()=>V.getBool(`WEBGL_RENDER_FLOAT32_ENABLED`)?4:0),V.registerFlag(`WEBGL_DELETE_TEXTURE_THRESHOLD`,()=>-1,e=>{if(typeof e!=`number`)throw Error(`WEBGL_DELETE_TEXTURE_THRESHOLD must be a number but got ${e}.`);if(e<0&&e!==-1)throw Error(`WEBGL_DELETE_TEXTURE_THRESHOLD must be -1 (indicating never delete) or at least 0, but got ${e}.`)}),V.registerFlag(`WEBGL_FLUSH_THRESHOLD`,()=>Ye()?1:-1,e=>{if(typeof e!=`number`)throw Error(`WEBGL_FLUSH_THRESHOLD must be a number but got ${e}.`);if(e<0&&e!==-1)throw Error(`WEBGL_FLUSH_THRESHOLD must be -1 (indicating never manual flush) or at least 0, but got ${e}.`)}),V.registerFlag(`CPU_HANDOFF_SIZE_THRESHOLD`,()=>128),V.registerFlag(`WEBGL_USE_SHAPES_UNIFORMS`,()=>!1),V.registerFlag(`TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD`,()=>1e5),V.registerFlag(`TOPK_K_CPU_HANDOFF_THRESHOLD`,()=>128),V.registerFlag(`WEBGL_EXP_CONV`,()=>!1),V.registerFlag(`SOFTWARE_WEBGL_ENABLED`,()=>V.getBool(`IS_TEST`)),V.registerFlag(`WEBGL_MAX_SIZE_FOR_NARROW_TEXTURE`,()=>1/0),V.registerFlag(`WEBGL_AUTO_SQUARIFY_NARROW_TEXTURE_SHAPE`,()=>!1),V.registerFlag(`WEBGL2_ISNAN_CUSTOM`,()=>!1),V.registerFlag(`ENGINE_COMPILE_ONLY`,()=>!1);function H(){let e,t,n,r,i,a,o,s,c,l;return N().getNumber(`WEBGL_VERSION`)===2?(e=`#version 300 es`,t=`in`,n=`out`,r=`in`,i=`texture`,a=`outputColor`,o=`out vec4 outputColor;`,s=N().getBool(`WEBGL2_ISNAN_CUSTOM`)?`
    ...
    `),{version:e,attribute:t,varyingVs:n,varyingFs:r,texture2D:i,output:a,defineOutput:o,defineSpecialNaN:s,defineSpecialInf:c,defineRound:l}}function Fa(e,t,n=`index`){let r=k(t);return r.map((t,i)=>`${`int ${e[i]} = ${n} / ${t}`}; ${i===r.length-1?`int ${e[i+1]} = ${n} - ${e[i]} * ${t}`:`index -= ${e[i]} * ${t}`};`).join(``)}function Ia(e,t,n=`index`){let r=k(t);return r.map((t,i)=>`${`int ${e[i]} = ${n} / outShapeStrides[${i}]`}; ${i===r.length-1?`int ${e[i+1]} = ${n} - ${e[i]} * outShapeStrides[${i}]`:`index -= ${e[i]} * outShapeStrides[${i}]`};`).join(``)}function La(e,t){let n=e.length,r=e.map(e=>`${t}[${e}]`),i=Array(n-1);i[n-2]=r[n-1];for(let e=n-3;e>=0;--e)i[e]=`(${i[e+1]} * ${r[e+1]})`;return i}function Ra(e,t,n=`index`){let r=La(e.map((e,t)=>t),t);return r.map((t,i)=>`${`int ${e[i]} = ${n} / ${r[i]}`}; ${i===r.length-1?`int ${e[i+1]} = ${n} - ${e[i]} * ${r[i]}`:`index -= ${e[i]} * ${r[i]}`};`).join(``)}function za(e){let t=k(e).map(e=>e.toString());return`
...
`;let r=Fa([`r`,`c`,`d`],e);return`
  ...
  `}function po(e,t,n){let r=[Math.ceil(t[0]/2),Math.ceil(t[1]/2)];if(O(e,t))return n?`
  ...
  `}function mo(e,t,n){return O(e,t)?n?`
      ivec2 getOutputCoords() {
  ...
  `}function bo(e,t){let n=e.shapeInfo.logicalShape,r=e.name,i=`get`+r.charAt(0).toUpperCase()+r.slice(1),a=e.shapeInfo.texShape,o=a[0],s=a[1],c=H();if(a!=null&&O(n,a))return t?`
  ...
  `}function xo(e,t){let n=e.shapeInfo.logicalShape,r=e.name,i=`get`+r.charAt(0).toUpperCase()+r.slice(1),a=e.shapeInfo.texShape;if(a!=null&&O(n,a)){if(t)return`
  ...
  `}let{newShape:o,keptDims:s}=li(n),c=o;if(c.length<n.length)return`
      ${Wa(Mo(e,c),t)}
      float ${i}(int row, int col) {
...
`}function So(e,t){let n=e.shapeInfo.logicalShape,r=e.name,i=`get`+r.charAt(0).toUpperCase()+r.slice(1),a=e.shapeInfo.texShape,o=[Math.ceil(a[0]/2),Math.ceil(a[1]/2)];if(n[0]===1)return`
  ...
  `}function Co(e,t){let n=e.shapeInfo.logicalShape,r=e.name,i=`get`+r.charAt(0).toUpperCase()+r.slice(1),a=n[1]*n[2],o=n[2],{newShape:s,keptDims:c}=li(n),l=s;if(l.length<n.length)return`
        ${Wa(Mo(e,l),t)}
  ...
  `}function To(e,t){let n=e.shapeInfo.logicalShape,r=e.name,i=`get`+r.charAt(0).toUpperCase()+r.slice(1),a=n[3],o=n[2]*a,s=n[1]*o,{newShape:c,keptDims:l}=li(n);if(c.length<n.length)return`
      ${Wa(Mo(e,c),t)}
  ...
  `}function Eo(e){let t=e.shapeInfo.logicalShape,n=e.name,r=`get`+n.charAt(0).toUpperCase()+n.slice(1),i=t[4],a=t[3]*i,o=t[2]*a,s=t[1]*o,{newShape:c,keptDims:l}=li(t);if(c.length<t.length)return`
      ${Wa(Mo(e,c))}
  ...
  `}function Do(e){let t=e.shapeInfo.logicalShape,n=e.name,r=`get`+n.charAt(0).toUpperCase()+n.slice(1),{newShape:i,keptDims:a}=li(t);if(i.length<t.length)return`
      ${Wa(Mo(e,i))}
...
`);let f=``;f=o<2&&a>0?`coords`:e.shapeInfo.logicalShape.map((e,t)=>`coords.${d[t+l]}`).join(`, `);let p=`return outputValue;`,m=T(e.shapeInfo.logicalShape)===1,h=T(t.logicalShape)===1;if(a===1&&!m&&!h)p=`
  ...
  `}function Ao(e,t){let n=e.name,r=n.charAt(0).toUpperCase()+n.slice(1),i=`get`+r+`AtOutCoords`,a=t.texShape,o=e.shapeInfo.texShape,s=e.shapeInfo.logicalShape.length,c=t.logicalShape.length;if(!e.shapeInfo.isUniform&&s===c&&e.shapeInfo.flatOffset==null&&O(o,a))return`
      float ${i}() {
...
`,Su=class{constructor(e,t,n,r=!1){this.variableNames=[`A`,`B`],this.supportsBroadcasting=!0,this.packedInputs=!0,this.packedOutput=!0,this.outputShape=j(t,n);let i=this.outputShape.length;this.enableShapeUniforms=W(i);let a=``;if(r)if(i===0||T(this.outputShape)===1)a=`
          result.y = 0.;
          result.z = 0.;
          result.w = 0.;
        `;else if(a=`
...
`;function Mu(e){let{inputs:t,backend:n}=e,{x:r,alpha:i}=t,a=N().getBool(`WEBGL_PACK_BINARY_OPERATIONS`)?new Su(ju,r.shape,i.shape):new bu(Au,r.shape,i.shape);return n.runWebGLProgram(a,[r,i],`float32`)}var Nu={kernelName:Me,backendName:`webgl`,kernelFunc:Mu},Pu=`if (isnan(x)) return x;`;function X({opSnippet:e,packedOpSnippet:t,cpuKernelImpl:n,dtype:r}){return({inputs:i,backend:a})=>{let{x:o}=i,s=a,c=r||o.dtype;if(s.shouldExecuteOnCPU([o])&&n!=null){let e=n(s.texData.get(o.dataId).values,c);return s.makeTensorInfo(o.shape,c,e)}let l=N().getBool(`WEBGL_PACK_UNARY_OPERATIONS`)&&t!=null,u;return u=l?new iu(o.shape,t):new Gl(o.shape,e),s.runWebGLProgram(u,[o],c)}}function Z({opSnippet:e,packedOpSnippet:t,checkOutOfBounds:n=!1,supportsComplex:r=!1,cpuKernelImpl:i,dtype:a}){return({inputs:o,backend:s})=>{let{a:c,b:l}=o,u=s;if(r&&c.dtype===`complex64`){let t=u.texData.get(c.dataId),n=u.texData.get(l.dataId),[r,i]=[[t.complexTensorInfos.real,n.complexTensorInfos.real],[t.complexTensorInfos.imag,n.complexTensorInfos.imag]].map(t=>{let[n,r]=t,i={dataId:n.dataId,dtype:n.dtype,shape:c.shape},a={dataId:r.dataId,dtype:r.dtype,shape:l.shape},o=new bu(e,c.shape,l.shape);return u.runWebGLProgram(o,[i,a],ue(n.dtype,r.dtype))}),a=wu({inputs:{real:r,imag:i},backend:u});return u.disposeIntermediateTensorInfo(r),u.disposeIntermediateTensorInfo(i),a}let d=a||ue(c.dtype,l.dtype);if((c.dtype===`string`||l.dtype===`string`||u.shouldExecuteOnCPU([c,l]))&&i!=null){let e=u.texData.get(c.dataId).values,t=u.texData.get(l.dataId).values,n=c.dtype===`string`?Yn(e):e,r=c.dtype===`string`?Yn(t):t,[a,o]=i(c.shape,l.shape,n,r,d),s=u.makeTensorInfo(o,d),f=u.texData.get(s.dataId);return f.values=a,s}let f=N().getBool(`WEBGL_PACK_BINARY_OPERATIONS`)&&t!=null,p;return p=f?new Su(t,c.shape,l.shape,n):new bu(e,c.shape,l.shape),u.runWebGLProgram(p,[c,l],d)}}function Fu(e,t=!1){if(e===`linear`)return t?$l:Kl;if(e===`relu`)return t?tu:Yl;if(e===`elu`)return t?eu:Jl;if(e===`relu6`)return t?nu:Xl;if(e===`prelu`)return t?ju:Au;if(e===`leakyrelu`)return t?Du:Eu;if(e===`sigmoid`)return t?ru:Ql;throw Error(`Activation ${e} has not been implemented for the WebGL backend.`)}var Iu=class{constructor(e,t,n,r=!1,i=!1,a=!1,o=null,s=!1,c=!1){this.variableNames=[`matrixA`,`matrixB`],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=n,this.enableShapeUniforms=W(this.outputShape.length);let l=r?e[1]:e[2],u=Math.ceil(l/2),d=r?`i * 2, rc.y`:`rc.y, i * 2`,f=i?`rc.z, i * 2`:`i * 2, rc.z`,p=r?[`a.xxyy`,`a.zzww`]:[`a.xxzz`,`a.yyww`],m=i?[`b.xzxz`,`b.ywyw`]:[`b.xyxy`,`b.zwzw`],h=``,g=``;o&&(h=s?`vec4 activation(vec4 a) {
    ...
    `}},Lu={REAL:`return areal * breal - aimag * bimag;`,IMAG:`return areal * bimag + aimag * breal;`},Ru=class{constructor(e,t,n){this.variableNames=[`AReal`,`AImag`,`BReal`,`BImag`],this.outputShape=j(t,n),this.userCode=`
    ...
    `}};function Zu(e,t,n){let r=N().getBool(`WEBGL_PACK_ARRAY_OPERATIONS`)?new Xu(e.shape,t):new Ju(e.shape,t);return n.runWebGLProgram(r,[e],e.dtype)}function Qu(e,t,n,r){let i=t,a=e.shape.length,o=F(i,e.shape),s=o,c=D(s,a),l=c!=null,u=e;l&&(u=Zu(e,c,r),s=E(s.length,a)),Le(`sum`,s,a);let[d,f]=Lr(u.shape,s),p=d;n&&(p=je(d,o));let m=T(f),h=T(e.shape)/m,g=Q({inputs:{x:u},attrs:{shape:[h,m]},backend:r}),_=qu(g,it(e.dtype),`sum`,r),v=Q({inputs:{x:_},attrs:{shape:p},backend:r});return r.disposeIntermediateTensorInfo(g),r.disposeIntermediateTensorInfo(_),l&&r.disposeIntermediateTensorInfo(u),v}function $u(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,keepDims:o}=r;return Qu(i,a,o,n)}var ed={kernelName:`Sum`,backendName:`webgl`,kernelFunc:$u};function $(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{perm:a}=r,o=n,s=i.shape.length,c=Array(s);for(let e=0;e<c.length;e++)c[e]=i.shape[a[e]];let l;if(o.shouldExecuteOnCPU([i])){let e=o.texData.get(i.dataId).values,t=jl(e,i.shape,i.dtype,a,c);l=o.makeTensorInfo(c,i.dtype);let n=o.texData.get(l.dataId);n.values=t}else l=Zu(i,a,o);return l}var td={kernelName:Wt,backendName:`webgl`,kernelFunc:$};function nd({a:e,b:t,transposeA:n,transposeB:r,backend:i,bias:a=null,preluActivationWeights:o=null,leakyreluAlpha:s=0,activation:c=null}){let l=e.shape.length,u=t.shape.length,d=n?e.shape[l-2]:e.shape[l-1],f=r?t.shape[u-1]:t.shape[u-2],p=n?e.shape[l-1]:e.shape[l-2],m=r?t.shape[u-2]:t.shape[u-1],h=e.shape.slice(0,-2),g=t.shape.slice(0,-2),_=T(h),v=T(g),y=j(e.shape.slice(0,-2),t.shape.slice(0,-2)).concat([p,m]);A(d===f,()=>`Error in matMul: inner shapes (${d}) and (${f}) of Tensors with shapes ${e.shape} and ${t.shape} and transposeA=${n} and transposeB=${r} must match.`);let b=n?[_,d,p]:[_,p,d],x=r?[v,m,f]:[v,f,m],S=Q({inputs:{x:e},backend:i,attrs:{shape:b}}),C=Q({inputs:{x:t},backend:i,attrs:{shape:x}}),w=[S,C],ee=Math.max(_,v),te=n?S.shape[1]:S.shape[2],ne=a!=null,re=o!=null,ie=c===`leakyrelu`,ae=c==null?null:Fu(c,!0),oe=ne||re||ie||ae!=null,se;if((p===1||m===1)&&te>1e3&&oe===!1){let e=S,t=C;n&&(e=$({inputs:{x:S},backend:i,attrs:{perm:[0,2,1]}}),w.push(e)),r&&(t=$({inputs:{x:C},backend:i,attrs:{perm:[0,2,1]}}),w.push(t));let a=m!==1,o=m===1,s=e;a&&(s=Q({inputs:{x:e},backend:i,attrs:{shape:[ee,te,1]}}),w.push(s));let c=m===1?2:1,l=t;o&&(l=Q({inputs:{x:t},backend:i,attrs:{shape:[ee,1,te]}}),w.push(l));let u=Bu({inputs:{a:s,b:l},backend:i});se=$u({inputs:{x:u},backend:i,attrs:{axis:c,keepDims:!0}}),w.push(u)}else{let c=ue(e.dtype,t.dtype),l=new Iu(b,x,[ee,p,m],n,r,ne,ae,re,ie),u=[S,C];if(a!=null&&u.push(a),re&&u.push(o),ie){let e=i.makeTensorInfo([],`float32`,mt(s,`float32`));u.push(e),w.push(e)}se=i.runWebGLProgram(l,u,c)}let ce=Q({inputs:{x:se},backend:i,attrs:{shape:y}});w.push(se);for(let e of w)i.disposeIntermediateTensorInfo(e);return ce}function rd(e){let{inputs:t,backend:n,attrs:r}=e,{a:i,b:a,bias:o,preluActivationWeights:s}=t,{transposeA:c,transposeB:l,activation:u,leakyreluAlpha:d}=r;return nd({a:i,b:a,transposeA:c,transposeB:l,backend:n,bias:o,preluActivationWeights:s,leakyreluAlpha:d,activation:u})}var id={kernelName:kn,backendName:`webgl`,kernelFunc:rd},ad=`return abs(x);`;function od(e){let{inputs:t,backend:n}=e,{x:r}=t;if(n.shouldExecuteOnCPU([r])&&r.dtype!==`complex64`){let e=_l(n.texData.get(r.dataId).values);return n.makeTensorInfo(r.shape,r.dtype,e)}let i;return i=N().getBool(`WEBGL_PACK_UNARY_OPERATIONS`)?new iu(r.shape,ad):new Gl(r.shape,ad),n.runWebGLProgram(i,[r],r.dtype)}var sd={kernelName:`Abs`,backendName:`webgl`,kernelFunc:od},cd={kernelName:Oe,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return acos(x);
`})},ld={kernelName:Ut,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`})},ud=`return a + b;`,dd={kernelName:`Add`,backendName:`webgl`,kernelFunc:Z({opSnippet:ud,packedOpSnippet:ud,supportsComplex:!0,cpuKernelImpl:Rc})},fd=class{constructor(e,t){this.outputShape=[],this.outputShape=e,this.variableNames=t.map((e,t)=>`T${t}`);let n=[];this.variableNames.forEach(e=>{n.push(`float v${e} = get${e}AtOutCoords();`)});let r=this.variableNames.map(e=>`v${e}`).join(` + `);this.userCode=`
    ...
    `}};function md(e){let{inputs:t,backend:n}=e,r=t;if(r.length===1)return Y({inputs:{x:r[0]},backend:n});if(r.length>N().getNumber(`WEBGL_MAX_TEXTURES_IN_SHADER`)){let e=Math.floor(r.length/2);return md({inputs:[md({inputs:r.slice(0,e),backend:n}),md({inputs:r.slice(e),backend:n})],backend:n})}let i=r.map(e=>e.dtype).reduce((e,t)=>ue(e,t)),a=r.map(e=>e.shape),o=N().getBool(`WEBGL_PACK`)?new pd(r[0].shape,a):new fd(r[0].shape,a);return n.runWebGLProgram(o,r,i)}var hd={kernelName:Yt,backendName:`webgl`,kernelFunc:md};function gd(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,keepDims:o}=r,s=i.shape.length,c=F(a,i.shape),l=c,u=D(l,s),d=i;u!=null&&(d=$({inputs:{x:i},backend:n,attrs:{perm:u}}),l=E(l.length,s)),Le(`all`,l,s);let[f,p]=Lr(d.shape,l),m=T(p),h=Q({inputs:{x:d},backend:n,attrs:{shape:[-1,m]}}),g=qu(h,h.dtype,`all`,n),_;if(o){let e=je(f,c);_=Q({inputs:{x:g},backend:n,attrs:{shape:e}})}else _=Q({inputs:{x:g},backend:n,attrs:{shape:f}});return n.disposeIntermediateTensorInfo(h),n.disposeIntermediateTensorInfo(g),u!=null&&n.disposeIntermediateTensorInfo(d),_}var _d={kernelName:`All`,backendName:`webgl`,kernelFunc:gd};function vd(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,keepDims:o}=r,s=i.shape.length,c=F(a,i.shape),l=c,u=D(l,s),d=i;u!=null&&(d=$({inputs:{x:i},backend:n,attrs:{perm:u}}),l=E(l.length,s)),Le(`any`,l,s);let[f,p]=Lr(d.shape,l),m=T(p),h=Q({inputs:{x:d},backend:n,attrs:{shape:[-1,m]}}),g=qu(h,h.dtype,`any`,n),_;if(o){let e=je(f,c);_=Q({inputs:{x:g},backend:n,attrs:{shape:e}})}else _=Q({inputs:{x:g},backend:n,attrs:{shape:f}});return n.disposeIntermediateTensorInfo(h),n.disposeIntermediateTensorInfo(g),u!=null&&n.disposeIntermediateTensorInfo(d),_}var yd={kernelName:`Any`,backendName:`webgl`,kernelFunc:vd},bd=class{constructor(e,t,n){this.variableNames=[`A`];let{windowSize:r,batchSize:i,outSize:a}=e;n||this.variableNames.push(`bestIndicesA`),this.outputShape=[i,a],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
        int outIdx = coords[1];
    ...
    `}};function Sd(e,t,n,r=null){let i=t.shape[0],a=t.shape[1];r!=null&&(i=r.shape[0],a=r.shape[1]);let o=At(a),s=new bd({windowSize:o,inSize:a,batchSize:i,outSize:Math.ceil(a/o)},n,r==null),c=[t];r!=null&&c.push(r);let l=e.runWebGLProgram(s,c,`int32`);if(l.shape[1]===1)return l;let u=Sd(e,t,n,l);return e.disposeIntermediateTensorInfo(l),u}function Cd(e,t,n,r=null){let i=r==null?t.shape:r.shape,a=i[i.length-1],o=new xd(i,At(a),n,r==null),s=r==null?[t]:[t,r],c=e.runWebGLProgram(o,s,`int32`);if(c.shape.length===t.shape.length){let r=Cd(e,t,n,c);return e.disposeIntermediateTensorInfo(c),r}return c}function wd(e,t,n,r){let i=[n];if(Le(`arg`+r.charAt(0).toUpperCase()+r.slice(1),i,t.shape.length),!N().getBool(`WEBGL_PACK_REDUCE`)||t.shape.length<=2){let n=[],a=e.texData.get(t.dataId),o=a!==null&&a.isPacked,s=t;o&&(s=e.unpackTensor(t),n.push(s));let[c,l]=Lr(s.shape,i),u=T(l),d=Q({inputs:{x:s},backend:e,attrs:{shape:[-1,u]}});n.push(d);let f=Sd(e,d,r);n.push(f);let p=Q({inputs:{x:f},backend:e,attrs:{shape:c}});return n.forEach(t=>e.disposeIntermediateTensorInfo(t)),p}return Cd(e,t,r)}function Td(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a}=r,o=F(a,i.shape),s=D(o,i.shape.length),c=i,l=[];s!=null&&(c=$({inputs:{x:i},backend:n,attrs:{perm:s}}),l.push(c),o=E(o.length,c.shape.length)),Le(`argMax`,[o[0]],c.shape.length);let u=wd(n,c,o[0],`max`);return l.forEach(e=>n.disposeIntermediateTensorInfo(e)),u}var Ed={kernelName:An,backendName:`webgl`,kernelFunc:Td};function Dd(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a}=r,o=F(a,i.shape),s=D(o,i.shape.length),c=i,l=[];s!=null&&(c=$({inputs:{x:i},backend:n,attrs:{perm:s}}),l.push(c),o=E(o.length,c.shape.length)),Le(`argMin`,[o[0]],c.shape.length);let u=wd(n,c,o[0],`min`);return l.forEach(e=>n.disposeIntermediateTensorInfo(e)),u}var Od={kernelName:qr,backendName:`webgl`,kernelFunc:Dd},kd={kernelName:xr,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return asin(x);
`})},Ad={kernelName:Br,backendName:`webgl`,kernelFunc:X({opSnippet:J+`return log(x + sqrt(x * x + 1.0));`})},jd={kernelName:Qn,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  return atan(x);
`})},Md={kernelName:un,backendName:`webgl`,kernelFunc:Z({opSnippet:yu+`
  return atan(a, b);
`,packedOpSnippet:`
  ...
  `+xu+`
  return result;
`})},Nd={kernelName:Er,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
...
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`})},Pd=class{constructor(e,t,n,r=!1,i=!1){if(this.variableNames=[`x`],t===`avg`&&n)throw Error(`Cannot compute positions for average pool.`);let a=e.filterWidth,o=e.strideHeight,s=e.strideWidth,c=e.dilationHeight,l=e.dilationWidth,u=e.effectiveFilterHeight,d=e.effectiveFilterWidth,f=e.padInfo.top,p=e.padInfo.left;this.outputShape=e.outShape;let m=t===`avg`,h=`((batch  * ${e.inHeight} + xR) * ${e.inWidth} + xC) * ${e.inChannels} + d`,g=`(xR * ${e.inWidth} + xC) * ${e.inChannels} + d`,_=`0.0`;if(m||(_=`-1.0 / 1e-20`),n){this.userCode=`
    ...
    `}};function Id(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t;Pa(i,`avgPool`);let{filterSize:a,strides:o,pad:s,dimRoundingMode:c}=r;A(Dn(o,1),()=>`Error in avgPool: Either strides or dilations must be 1. Got strides ${o} and dilations '1'`);let l=Zt(i.shape,a,o,1,s,c);if(l.filterWidth===1&&l.filterHeight===1&&O(l.inShape,l.outShape))return Y({inputs:{x:i},backend:n});let u=new Pd(l,`avg`,!1);return n.runWebGLProgram(u,[i],`float32`)}var Ld={kernelName:Wr,backendName:`webgl`,kernelFunc:Id};function Rd(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{filterSize:a,strides:o,pad:s,dimRoundingMode:c,dataFormat:l}=r,u=new Fd(ut(i.shape,a,o,[1,1,1],s,c,l),`avg`,!1);return n.runWebGLProgram(u,[i],`float32`)}var zd={kernelName:bn,backendName:`webgl`,kernelFunc:Rd},Bd=class{constructor(e){this.variableNames=[`dy`],this.outputShape=e.inShape;let t=e.filterHeight,n=e.filterWidth,r=e.strideHeight,i=e.strideWidth,a=e.dilationHeight,o=e.dilationWidth,s=e.effectiveFilterHeight,c=e.effectiveFilterWidth;this.userCode=`
    ...
    `}};function Hd(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,input:a}=t,o=a,{filterSize:s,strides:c,pad:l,dimRoundingMode:u}=r,d=new Vd(ut(o.shape,s,c,[1,1,1],l,u));return n.runWebGLProgram(d,[i],o.dtype)}var Ud={kernelName:fr,backendName:`webgl`,kernelFunc:Hd};function Wd(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,input:a}=t,o=a;Pa([i,a],`avgPoolGrad`);let{filterSize:s,strides:c,pad:l}=r,u=new Bd(Zt(o.shape,s,c,1,l));return n.runWebGLProgram(u,[i],o.dtype)}var Gd={kernelName:$r,backendName:`webgl`,kernelFunc:Wd};function Kd(e){let{inputs:t,backend:n,attrs:r}=e,{a:i,b:a}=t,{transposeA:o,transposeB:s}=r;return nd({a:i,b:a,transposeA:o,transposeB:s,backend:n})}var qd={kernelName:Tn,backendName:`webgl`,kernelFunc:Kd},Jd=class{constructor(e,t,n,r,i,a){this.outputShape=[],this.variableNames=[`x`,`mean`,`variance`],j(e,t),j(e,n);let o=`0.0`;r!=null&&(j(e,r),this.variableNames.push(`offset`),o=`getOffsetAtOutCoords()`);let s=`1.0`;i!=null&&(j(e,i),this.variableNames.push(`scale`),s=`getScaleAtOutCoords()`),this.outputShape=e,this.userCode=`
      void main() {
...
`)}
    ...
    `}};function tf(e,t,n,r){let i=r.texData.get(e.dataId),a=r.makeTensorInfo(n,e.dtype),o=r.texData.get(a.dataId);Object.assign(o,i),o.refCount=1,o.shape=n,o.dtype=e.dtype;let s=Jt(t,k(e.shape));i.slice&&(s+=i.slice.flatOffset),o.slice={flatOffset:s,origDataId:i.slice&&i.slice.origDataId||e.dataId};let c=r.dataRefCount.get(o.slice.origDataId)||1;return r.dataRefCount.set(o.slice.origDataId,c+1),a}function nf(e){let{inputs:n,backend:r,attrs:i}=e,{x:a}=n,{begin:o,size:s}=i,[c,l]=Mn(a,o,s);if(Lt(a,c,l),T(l)===0)return r.makeTensorInfo(l,a.dtype,[]);if(r.shouldExecuteOnCPU([a])||a.dtype===`string`){let e=vl(r.texData.get(a.dataId).values,c,l,a.shape,a.dtype);return r.makeTensorInfo(l,a.dtype,e)}let{isPacked:u}=r.texData.get(a.dataId),d=t(a.shape,c,l);if(u||!d){let e=N().getBool(`WEBGL_PACK_ARRAY_OPERATIONS`)?new ef(l):new Zd(l),t=[c];return r.runWebGLProgram(e,[a],a.dtype,t)}return r.uploadToGPU(a.dataId),tf(a,c,l,r)}var rf={kernelName:vt,backendName:`webgl`,kernelFunc:nf},af={kernelName:In,backendName:`webgl`,kernelFunc:e=>{let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{blockShape:a,crops:o}=r;A(i.shape.length<=4,()=>`batchToSpaceND for rank > 4 with a WebGL backend not implemented yet`);let s=a.reduce((e,t)=>e*t),c=Se(i.shape,a,s),l=le(c.length,a.length),u=ze(i.shape,a,s),d=pt(o,a.length),f=yi(u,o,a.length),p=[],m=Q({inputs:{x:i},backend:n,attrs:{shape:c}}),h=$({inputs:{x:m},backend:n,attrs:{perm:l}}),g=Q({inputs:{x:h},backend:n,attrs:{shape:u}}),_=nf({inputs:{x:g},backend:n,attrs:{begin:d,size:f}});return p.push(m),p.push(h),p.push(g),p.forEach(e=>n.disposeIntermediateTensorInfo(e)),_}};function of(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,weights:a}=t,{size:o}=r,s=zc(n.readSync(i.dataId),n.readSync(a.dataId),a.dtype,a.shape,o);return n.makeTensorInfo([o],a.dtype,s)}var sf={kernelName:jr,backendName:`webgl`,kernelFunc:of},cf=`
...
`;function uf(e){let{inputs:t,backend:n}=e,{a:r,b:i}=t,a=N().getBool(`WEBGL_PACK_BINARY_OPERATIONS`),o=N().getNumber(`WEBGL_VERSION`);if(n.shouldExecuteOnCPU([r,i])||o===1){let e=n.texData.get(r.dataId).values,t=n.texData.get(i.dataId).values,[a,o]=Vc(r.shape,i.shape,e,t,r.dtype),s=n.makeTensorInfo(o,r.dtype),c=n.texData.get(s.dataId);return c.values=a,s}let s;return s=a?new Su(cf,r.shape,i.shape,!1):new bu(lf,r.shape,i.shape),n.runWebGLProgram(s,[r,i],r.dtype)}var df={kernelName:gr,backendName:`webgl`,kernelFunc:uf};function ff(e){let{inputs:t,backend:n}=e,{s0:r,s1:i}=t,a=n.readSync(r.dataId),o=n.readSync(i.dataId),s=j(Array.from(a),Array.from(o));return n.makeTensorInfo([s.length],`int32`,Int32Array.from(s))}var pf={kernelName:qn,backendName:`webgl`,kernelFunc:ff},mf=Z({opSnippet:`return float(a != b);`,cpuKernelImpl:cl,dtype:`bool`}),hf={kernelName:xe,backendName:`webgl`,kernelFunc:mf};function gf(e){let{inputs:t,backend:n}=e,{input:r}=t;return Y({inputs:{x:n.texData.get(r.dataId).complexTensorInfos.real},backend:n})}var _f={kernelName:On,backendName:`webgl`,kernelFunc:gf},vf=`return float(int(x));`;function yf(e,t){let n=new Gl(e.shape,vf),r=t.runWebGLProgram(n,[e],`int32`);return{dataId:r.dataId,shape:r.shape,dtype:r.dtype}}function bf(e){let{inputs:t,backend:n,attrs:r}=e,{x:a}=t,{dtype:o}=r;if(o===`complex64`){if(a.dtype===`complex64`)return Y({inputs:{x:a},backend:n});let e=i(a.shape),t=bf({inputs:{x:a},backend:n,attrs:{dtype:`float32`}}),r=wu({inputs:{real:t,imag:e},backend:n});return e.dispose(),n.disposeIntermediateTensorInfo(t),r}if(a.dtype===`complex64`){let e=gf({inputs:{input:a},backend:n}),t=bf({inputs:{x:e},backend:n,attrs:{dtype:o}});return n.disposeIntermediateTensorInfo(e),t}if(!dr(a.dtype,o)){let e=Y({inputs:{x:a},backend:n});return{dataId:e.dataId,shape:e.shape,dtype:o}}if(n.shouldExecuteOnCPU([a])){let e=n.texData.get(a.dataId).values,[t,r,i]=Hc(e,a.shape,a.dtype,o);return n.makeTensorInfo(t,r,i)}if(o===`int32`)return yf(a,n);if(o===`bool`){let e=n.makeTensorInfo([],`bool`,yn(`bool`,1)),t=mf({inputs:{a,b:e},backend:n});return n.disposeIntermediateTensorInfo(e),t}throw Error(`Error in Cast: failed to cast ${a.dtype} to ${o}`)}var xf={kernelName:Hn,backendName:`webgl`,kernelFunc:bf},Sf=`return ceil(x);`,Cf={kernelName:an,backendName:`webgl`,kernelFunc:X({opSnippet:Sf,packedOpSnippet:Sf,cpuKernelImpl:Uc})},wf=class{constructor(e){this.variableNames=[`A`],this.customUniforms=[{name:`minVal`,type:`float`},{name:`maxVal`,type:`float`}],this.outputShape=e,this.userCode=`
       ...
       `;for(let t=0;t<(u+1)/2;t++){let n=t*2;if(d+=`
           ...
           `,o===1){if(n<l&&(a%2==1?(d+=`
               ...
               `,s===1&&n>0?d+=`
                 ...
                 xC${n} = xTexelC${n};
                 `,n+1<l)){let e=a%2==0?ri(s):s;s%2==0&&a%2==1||s%2!=0&&a%2!=1?(d+=`
   ...
   `;let f=``,p=``;n&&(f=r?`vec4 activation(vec4 a) {
    ...
    `}};function ep(e){let{inputs:t,backend:n,attrs:i}=e,{x:a,dy:o}=t,{strides:s,pad:c,dataFormat:l,dimRoundingMode:u,filterShape:d}=i,f=r(l),p=new Xf(Ae(a.shape,d,s,1,c,u,!1,f));return n.runWebGLProgram(p,[a,o],`float32`)}var tp={kernelName:b,backendName:`webgl`,kernelFunc:ep},np=class{constructor(e){this.variableNames=[`dy`,`W`],this.packedInputs=!0,this.packedOutput=!0,this.customUniforms=[{name:`strides`,type:`vec2`}],this.outputShape=e.inShape,this.enableShapeUniforms=W(this.outputShape.length);let t=e.filterHeight,n=e.filterWidth;this.userCode=`
      const ivec2 pads = ivec2(${t-1-e.padInfo.top}, ${n-1-e.padInfo.left});
    ...
    `}};function rp(e){let{inputs:t,backend:n,attrs:i}=e,{dy:a,filter:o}=t,{inputShape:s,strides:c,pad:l,dataFormat:u,dimRoundingMode:d}=i,f=r(u),p=Ae(s,o.shape,c,1,l,d,!1,f);if(N().getBool(`WEBGL_PACK_CONV2DTRANSPOSE`)&&f===`channelsLast`){let e=[[p.strideHeight,p.strideWidth]],t=new np(p);return n.runWebGLProgram(t,[a,o],`float32`,e)}else{let e=new Zf(p);return n.runWebGLProgram(e,[a,o],`float32`)}}var ip={kernelName:ui,backendName:`webgl`,kernelFunc:rp};function ap(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,filter:a}=t,{strides:o,pad:s,dilations:c}=r,l=new Hf(Gt(i.shape,a.shape,o,c,s));return n.runWebGLProgram(l,[i,a],`float32`)}var op={kernelName:wt,backendName:`webgl`,kernelFunc:ap};function sp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,dy:a}=t,{strides:o,pad:s,filterShape:c}=r,l=new Qf(Gt(i.shape,c,o,1,s));return n.runWebGLProgram(l,[i,a],`float32`)}var cp={kernelName:se,backendName:`webgl`,kernelFunc:sp};function lp(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,filter:a}=t,{pad:o,strides:s,inputShape:c}=r,l=new $f(Gt(c,a.shape,s,1,o));return n.runWebGLProgram(l,[i,a],`float32`)}var up={kernelName:ee,backendName:`webgl`,kernelFunc:lp},dp={kernelName:`Cos`,backendName:`webgl`,kernelFunc:X({opSnippet:Pu+`
  return cos(x);
`,packedOpSnippet:`
  vec4 result = cos(x);
  bvec4 isNaN = isnan(x);
  ${xu}
  return result;
`})},fp={kernelName:sr,backendName:`webgl`,kernelFunc:X({opSnippet:`
  float e2x = exp(-x);
...
`})},pp=class{constructor(e,t,n,r,i){this.variableNames=[`Image`,`Boxes`,`BoxInd`],this.outputShape=[];let[a,o,s,c]=e,[l]=t,[u,d]=n;this.outputShape=[l,u,d,c];let f=r===`bilinear`?1:0,[p,m]=[`${o-1}.0`,`${s-1}.0`],[h,g,_]=u>1?[`${(o-1)/(u-1)}`,`(y2-y1) * height_ratio`,`y1*${p} + float(y)*(height_scale)`]:[`0.0`,`0.0`,`0.5 * (y1+y2) * ${p}`],[v,y,b]=d>1?[`${(s-1)/(d-1)}`,`(x2-x1) * width_ratio`,`x1*${m} + float(x)*(width_scale)`]:[`0.0`,`0.0`,`0.5 * (x1+x2) * ${m}`];this.userCode=`
    ...
    `}};function _p(e,t,n){if(e===1)return`${t}`;if(e===2)return`${t}.x, ${t}.y`;if(e===3)return`${t}.x, ${t}.y, ${t}.z`;if(e===4)return`${t}.x, ${t}.y, ${t}.z, ${t}.w`;throw Error(`Cumulative ${n} for rank ${e} is not yet supported`)}function vp(e,t,n){if(e===1)return`${t}`;if(e===2)return`${t}.y`;if(e===3)return`${t}.z`;if(e===4)return`${t}.w`;throw Error(`Cumulative ${n} for rank ${e} is not yet supported`)}function yp(e,t,n,r,i,a){let o=t.shape.length,s=D([r],o),c=t;s!=null&&(c=$({inputs:{x:t},backend:n,attrs:{perm:s}}));let l=E(1,o)[0];if(l!==o-1)throw Error(`WebGL cumprod shader expects an inner-most axis=${t.shape.length-1} but got axis=${r}`);let u=c.shape[l],d=Y({inputs:{x:c},backend:n});for(let t=0;t<=Math.ceil(Math.log2(u))-1;t++){let r=new gp(e,c.shape,!1,a),i=[[t]],o=d;d=n.runWebGLProgram(r,[d],d.dtype,i),n.disposeIntermediateTensorInfo(o)}if(i){let t=new gp(e,c.shape,i,a),r=d;d=n.runWebGLProgram(t,[d],d.dtype),n.disposeIntermediateTensorInfo(r)}if(s!=null){let e=$t(s),t=$({inputs:{x:d},backend:n,attrs:{perm:e}});return n.disposeIntermediateTensorInfo(d),n.disposeIntermediateTensorInfo(c),t}return d}function bp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,exclusive:o,reverse:s}=r;return yp(hp.Prod,i,n,a,o,s)}var xp={kernelName:nr,backendName:`webgl`,kernelFunc:bp};function Sp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,exclusive:o,reverse:s}=r;return yp(hp.Sum,i,n,a,o,s)}var Cp={kernelName:qe,backendName:`webgl`,kernelFunc:Sp};function wp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,weights:a}=t,{size:o,binaryOutput:s}=r;if(i.shape.length===1){let e=zc(n.readSync(i.dataId),n.readSync(a.dataId),a.dtype,a.shape,o);return n.makeTensorInfo([o],a.dtype,e)}else if(i.shape.length===2){let e=Bc(n.bufferSync(i),n.bufferSync(a),o,s);return n.makeTensorInfo(e.shape,a.dtype,e.values)}throw Error(`Error in denseBincount: input must be at most rank 2, but got rank${i.shape.length}.`)}var Tp={kernelName:Ze,backendName:`webgl`,kernelFunc:wp},Ep=class{constructor(e,t,n){this.variableNames=[`x`],this.outputShape=[],this.outputShape=e,this.blockSize=t,this.dataFormat=n,this.userCode=`
    void main() {
      ivec4 coords = getOutputCoords();
      int b = coords[0];
      ...
      `;for(let e=0;e<(d+1)/2;e++){let t=e*2;if(f+=`
          ...
          `,s===1){if(t<u&&(o%2==1?(f+=`
              ...
              `,c===1&&t>0?f+=`
                ...
                xC${t} = xTexelC${t};
                `,t+1<u)){let e=o%2==0?ri(c):c;c%2==0&&o%2==1||c%2!=0&&o%2!=1?(f+=`
                  xCOffset = xC + imod(pads[1], 2) + ${e};
  ...
  `,f+=`
    ...
    `}};function jp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,filter:a}=t,{strides:o,pad:s,dilations:c,dimRoundingMode:l}=r,u=c;u??=[1,1],A(Dn(o,u),()=>`Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ${o} and dilations '${u}'`);let d=Ae(i.shape,a.shape,o,u,s,l,!0),f;f=N().getBool(`WEBGL_PACK_DEPTHWISECONV`)&&d.strideWidth<=2&&d.outChannels/d.inChannels===1?new Ap(d):new kp(d);let p=[[d.padInfo.top,d.padInfo.left],[d.strideHeight,d.strideWidth],[d.dilationHeight,d.dilationWidth],[d.inHeight,d.inWidth]];return n.runWebGLProgram(f,[i,a],`float32`,p)}var Mp={kernelName:fe,backendName:`webgl`,kernelFunc:jp},Np=class{constructor(e){this.variableNames=[`x`,`dy`],this.outputShape=e.filterShape;let t=e.strideHeight,n=e.strideWidth,r=e.padInfo.top,i=e.padInfo.left;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int wR = coords.x;
        int wC = coords.y;
    ...
    `}};function Fp(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,dy:a}=t,{strides:o,dilations:s,pad:c,dimRoundingMode:l,filterShape:u}=r,d=new Np(Ae(i.shape,u,o,s,c,l,!0));return n.runWebGLProgram(d,[i,a],`float32`)}var Ip={kernelName:we,backendName:`webgl`,kernelFunc:Fp};function Lp(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,filter:a}=t,{strides:o,dilations:s,pad:c,dimRoundingMode:l,inputShape:u}=r,d=new Pp(Ae(u,a.shape,o,s,c,l,!0));return n.runWebGLProgram(d,[i,a],`float32`)}var Rp={kernelName:He,backendName:`webgl`,kernelFunc:Lp},zp=class{constructor(e){this.variableNames=[`X`],this.outputShape=[e,e],this.userCode=`
      void main() {
          ivec2 coords = getOutputCoords();
          float val = coords[0] == coords[1] ? getX(coords[0]) : 0.0;
          setOutput(val);
      }
    `}};function Bp(e){let{inputs:t,backend:n}=e,{x:r}=t,i=[...r.shape,...r.shape],a=T(r.shape),o=Q({inputs:{x:r},backend:n,attrs:{shape:[a]}}),s=new zp(a),c=n.runWebGLProgram(s,[o],o.dtype),l=Q({inputs:{x:c},backend:n,attrs:{shape:i}});return n.disposeIntermediateTensorInfo(o),n.disposeIntermediateTensorInfo(c),l}var Vp={kernelName:gt,backendName:`webgl`,kernelFunc:Bp},Hp=class{constructor(e){this.variableNames=[`x`,`W`],this.outputShape=e.outShape;let{inHeight:t,inWidth:n,padInfo:r,strideHeight:i,strideWidth:a,filterHeight:o,filterWidth:s,dilationHeight:c,dilationWidth:l}=e,{top:u,left:d}=r;this.userCode=`
    ...
    `}};function Up(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,filter:a}=t,{strides:o,pad:s,dilations:c}=r,l=zt(i.shape,a.shape,o,s,`NHWC`,c),u,d=new Hp(l);u=n.runWebGLProgram(d,[i,a],`float32`);let f=Q({inputs:{x:u},backend:n,attrs:{shape:l.outShape}});return n.disposeIntermediateTensorInfo(u),f}var Wp={kernelName:Si,backendName:`webgl`,kernelFunc:Up};function Gp(e){let{inputs:t,backend:n,attrs:r}=e,{equation:i}=r,a=t,{allDims:o,summedDims:s,idDims:c}=_t(i,a.length);di(o.length,c,a);let{path:l,steps:u}=_(s,c),d=u.length,f=null,p=o.length,m=[];for(let e=0;e<d;++e){for(let t of u[e]){let{permutationIndices:e,expandDims:r}=oi(p,c[t]),i;xt(e)?i=a[t]:(i=$({inputs:{x:a[t]},backend:n,attrs:{perm:e}}),m.push(i));let o=i.shape.slice();for(let e=0;e<r.length;++e)o.splice(r[e],0,1);O(i.shape,o)||(i=Q({inputs:{x:i},backend:n,attrs:{shape:o}}),m.push(i)),f===null?f=i:(f=Bu({inputs:{a:i,b:f},backend:n}),m.push(f))}e<d-1&&(l[e]>=0&&(f=$u({inputs:{x:f},backend:n,attrs:{axis:l[e]-(o.length-p),keepDims:!1}}),m.push(f)),p--)}for(let e of m)e!==f&&n.disposeIntermediateTensorInfo(e);return f}var Kp={kernelName:h,backendName:`webgl`,kernelFunc:Gp},qp={kernelName:`Elu`,backendName:`webgl`,kernelFunc:X({opSnippet:`return (x >= 0.0) ? x : (exp(x) - 1.0);`,packedOpSnippet:`
  vec4 result;
...
`,Xp={kernelName:ye,backendName:`webgl`,kernelFunc:e=>{let{inputs:t,backend:n}=e,{dy:r,y:i}=t,a=N().getBool(`WEBGL_PACK_BINARY_OPERATIONS`)?new Su(Yp,r.shape,i.shape):new bu(Jp,r.shape,i.shape);return n.runWebGLProgram(a,[r,i],r.dtype)}},Zp={kernelName:Ot,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a == b);`,packedOpSnippet:`
...
`,packedOpSnippet:`
  ...
  return result;
`,cpuKernelImpl:Kc,dtype:`float32`}),em={kernelName:`Exp`,backendName:`webgl`,kernelFunc:$p};function tm(e){let{inputs:t,attrs:n,backend:r}=e,{dim:i}=n,{input:a}=t,o=a.shape.length,s=a.shape.slice(),c=i;return i<0&&(A(-(o+1)<=i,()=>`Axis must be in the interval [${-(o+1)}, ${o}]`),c=o+i+1),s.splice(c,0,1),Q({inputs:{x:a},backend:r,attrs:{shape:s}})}var nm={kernelName:Ie,backendName:`webgl`,kernelFunc:tm},rm=`return exp(x) - 1.0;`,im={kernelName:Ir,backendName:`webgl`,kernelFunc:X({opSnippet:rm,packedOpSnippet:rm,cpuKernelImpl:qc})},am=class{constructor(e,t,n){this.variableNames=[`real`,`imag`];let r=t[1];this.outputShape=t;let i=n?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,a=n?`${r}.0`:`1.0`,o;if(e===`real`)o=`return real * expR - imag * expI;`;else if(e===`imag`)o=`return real * expI + imag * expR;`;else throw Error(`FFT component must be either "real" or "imag", got ${e}.`);this.userCode=`
    ...
    `}};function um(e){let{backend:t,attrs:n}=e,{shape:r,value:i}=n,{dtype:a}=n;if(a||=wn(i),a===`string`){let e=M(a,T(r));return e.fill(i),t.makeTensorInfo(r,a,e)}else{let e=new lm(r,i),n=[[i]];return t.runWebGLProgram(e,[],a,n)}}var dm={kernelName:Kt,backendName:`webgl`,kernelFunc:um},fm=class{constructor(e){this.variableNames=[`Image`],this.outputShape=[];let t=e[2];this.outputShape=e,this.userCode=`
        void main() {
          ivec4 coords = getOutputCoords();
          int x = coords[2];
    ...
    `}},pm={kernelName:Bt,backendName:`webgl`,kernelFunc:({inputs:e,backend:t})=>{let{image:n}=e,r=t,i=new fm(n.shape);return r.runWebGLProgram(i,[n],n.dtype)}},mm=`return floor(x);`,hm={kernelName:Qt,backendName:`webgl`,kernelFunc:X({opSnippet:mm,packedOpSnippet:mm,cpuKernelImpl:Jc})},gm={kernelName:dt,backendName:`webgl`,kernelFunc:Z({opSnippet:`
...
`,dtype:`int32`})},_m=class{constructor(e){this.variableNames=[`A`];let t=H(),[n,r]=e;this.outputShape=e,this.userCode=`
    ...
    `}},ym={kernelName:a,backendName:`webgl`,kernelFunc:Sm},bm,xm=N().getBool(`CANVAS2D_WILL_READ_FREQUENTLY_FOR_GPU`);function Sm(e){let{inputs:t,backend:n,attrs:r}=e,{pixels:i}=t,{numChannels:a}=r,o=typeof HTMLVideoElement<`u`&&i instanceof HTMLVideoElement,s=typeof HTMLImageElement<`u`&&i instanceof HTMLImageElement,[c,l]=o?[i.videoWidth,i.videoHeight]:[i.width,i.height],u=[l,c],d=[l,c,a];if(s||o){let e=N().getBool(`CANVAS2D_WILL_READ_FREQUENTLY_FOR_GPU`);(bm==null||e!==xm)&&(xm=e,bm=document.createElement(`canvas`).getContext(`2d`,{willReadFrequently:xm})),bm.canvas.width=c,bm.canvas.height=l,bm.drawImage(i,0,0,c,l),i=bm.canvas}let f=n.makeTensorInfo(u,`int32`);n.texData.get(f.dataId).usage=L.PIXELS,n.gpgpu.uploadPixelDataToTexture(n.getTexture(f.dataId),i);let p=N().getBool(`WEBGL_PACK`)?new vm(d):new _m(d),m=n.runWebGLProgram(p,[f],`int32`);return n.disposeData(f.dataId),m}function Cm(e){let{inputs:t,backend:n,attrs:i}=e,{x:a,filter:o,bias:s,preluActivationWeights:c}=t,{strides:l,pad:u,dataFormat:d,dilations:f,dimRoundingMode:p,activation:m,leakyreluAlpha:h}=i,g=r(d),_=Ae(a.shape,o.shape,l,f,u,p,!1,g),v,y=[],b=s!=null,x=c!=null,S=m===`leakyrelu`,C=()=>{let e=[a,o],t=(e,t)=>{if(t===`NCHW`&&e.shape.length===1&&e.shape[0]!==1){let t=Q({inputs:{x:e},backend:n,attrs:{shape:[e.shape[0],1,1]}});return y.push(t),t}return e};if(b&&e.push(t(s,d)),x&&e.push(t(c,d)),S){let t=n.makeTensorInfo([],`float32`,mt(h,`float32`));e.push(t),y.push(t)}return e};if(_.filterHeight===1&&_.filterWidth===1&&_.dilationHeight===1&&_.dilationWidth===1&&_.strideHeight===1&&_.strideWidth===1&&(_.padInfo.type===`SAME`||_.padInfo.type===`VALID`))v=Kf({x:a,filter:o,convInfo:_,backend:n,bias:s,activation:m,preluActivationWeights:c,leakyreluAlpha:h});else if(_.strideWidth<=2&&g===`channelsLast`&&N().getBool(`WEBGL_EXP_CONV`)){let e=new Uf(_,b,m?Fu(m,!0):null,x,S),t=[[_.padInfo.top,_.padInfo.left],[_.strideHeight,_.strideWidth],[_.dilationHeight,_.dilationWidth],[_.inHeight,_.inWidth]],r=C();v=n.runWebGLProgram(e,r,`float32`,t)}else if(N().getBool(`WEBGL_CONV_IM2COL`))v=qf({x:a,filter:o,convInfo:_,backend:n,bias:s,activation:m,preluActivationWeights:c,leakyreluAlpha:h});else{let e=new Vf(_,b,m?Fu(m,!1):null,x,S),t=C();v=n.runWebGLProgram(e,t,`float32`)}let w=Q({inputs:{x:v},backend:n,attrs:{shape:_.outShape}});return y.push(v),y.forEach(e=>n.disposeIntermediateTensorInfo(e)),w}var wm={kernelName:Jr,backendName:`webgl`,kernelFunc:Cm};function Tm(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,filter:a,bias:o,preluActivationWeights:s}=t,{strides:c,pad:l,dilations:u,dimRoundingMode:d,activation:f,leakyreluAlpha:p}=r,m=[],h=u;h??=[1,1],A(Dn(c,h),()=>`Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ${c} and dilations '${h}'`);let g=Ae(i.shape,a.shape,c,h,l,d,!0),_=N().getBool(`WEBGL_PACK_DEPTHWISECONV`)&&g.strideWidth<=2&&g.outChannels/g.inChannels===1,v=f?Fu(f,_):null,y=[i,a],b=o!=null,x=s!=null,S=f===`leakyrelu`;if(b&&y.push(o),x&&y.push(s),S){let e=n.makeTensorInfo([],`float32`,mt(p,`float32`));y.push(e),m.push(e)}let C;C=_?new Ap(g,b,v,x,S):new kp(g,b,v,x,S);let w=[[g.padInfo.top,g.padInfo.left],[g.strideHeight,g.strideWidth],[g.dilationHeight,g.dilationWidth],[g.inHeight,g.inWidth]],ee=n.runWebGLProgram(C,y,`float32`,w);return m.forEach(e=>n.disposeIntermediateTensorInfo(e)),ee}var Em={kernelName:Sr,backendName:`webgl`,kernelFunc:Tm},Dm=class{constructor(e,t,n,r){this.sliceDim=e,this.strides=t,this.paramsShape=r,this.variableNames=[`x`,`indices`],this.outputShape=n;let i=U(n.length),a=`
    int index;`;for(let e=0;e<this.sliceDim;e++)a+=`
      ...
      `}};function Om(e){let{inputs:t,backend:n}=e,{params:r,indices:i}=t,a=i.shape,o=a[a.length-1],s=T(r.shape),[c,l,u,d]=Cr(r,i),f=Q({inputs:{x:i},backend:n,attrs:{shape:[l,o]}}),p=Q({inputs:{x:r},backend:n,attrs:{shape:[T(r.shape)/u,u]}});if(n.shouldExecuteOnCPU([r,i])||r.dtype===`string`){let e=Yc(n.readSync(i.dataId),n.bufferSync(r),r.dtype,l,o,u,d,r.shape,s);return n.makeTensorInfo(c,r.dtype,e.values)}let m=new Dm(o,d,[l,u],r.shape),h=n.runWebGLProgram(m,[p,f],p.dtype),g=Q({inputs:{x:h},backend:n,attrs:{shape:c}});return n.disposeIntermediateTensorInfo(f),n.disposeIntermediateTensorInfo(p),n.disposeIntermediateTensorInfo(h),g}var km={kernelName:Vr,backendName:`webgl`,kernelFunc:Om},Am=class{constructor(e,t){this.variableNames=[`A`,`indices`],this.outputShape=t,this.rank=t.length;let n=U(this.rank),r=jm(e,2);this.userCode=`
      void main() {
    ...
    `}};function jm(e,t){let n=[`resRC.x`,`resRC.y`,`resRC.z`,`resRC.w`],r=[];for(let t=0;t<e.length;t++)t===2?r.push(`index`):r.push(`${n[t]}`);return r.join()}function Mm(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,indices:a}=t,{axis:o,batchDims:s}=r,c=F(o,i.shape)[0];if(N().get(`DEBUG`)){let e=n.readSync(a.dataId),t=i.shape[c];for(let n=0;n<e.length;++n){let r=e[n];A(r<=t-1&&r>=0,()=>`GatherV2: the index value ${r} is not in [0, ${t-1}]`)}}let l=sn(i,a,c,s),u=T(a.shape),d=[],f=Q({inputs:{x:i},backend:n,attrs:{shape:[l.batchSize,l.outerSize,l.dimSize,l.sliceSize]}}),p=Q({inputs:{x:a},backend:n,attrs:{shape:[l.batchSize,u/l.batchSize]}});d.push(f),d.push(p);let m=[l.batchSize,l.outerSize,u/l.batchSize,l.sliceSize];if(n.shouldExecuteOnCPU([i,a])||i.dtype===`string`){let e=n.bufferSync(p),t=Xc(n.bufferSync(f),e,m);return d.forEach(e=>n.disposeIntermediateTensorInfo(e)),n.makeTensorInfo(l.outputShape,t.dtype,t.values)}let h=new Am(f.shape,m),g=n.runWebGLProgram(h,[f,p],f.dtype);d.push(g);let _=Q({inputs:{x:g},backend:n,attrs:{shape:l.outputShape}});return d.forEach(e=>n.disposeIntermediateTensorInfo(e)),_}var Nm={kernelName:$n,backendName:`webgl`,kernelFunc:Mm},Pm={kernelName:dn,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a > b);`,packedOpSnippet:`
  return vec4(greaterThan(a, b));
`,cpuKernelImpl:Zc,dtype:`bool`})},Fm={kernelName:Dr,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a >= b);`,packedOpSnippet:`
  return vec4(greaterThanEqual(a, b));
`,dtype:`bool`,cpuKernelImpl:Qc})};function Im(e){let{inputs:t,backend:n}=e,{input:r}=t;return om(r,!0,n)}var Lm={kernelName:Gr,backendName:`webgl`,kernelFunc:Im},Rm={kernelName:ei,backendName:`webgl`,kernelFunc:X({opSnippet:`return float(!isnan(x) && !isinf(x));`,dtype:`bool`})},zm={kernelName:En,backendName:`webgl`,kernelFunc:X({opSnippet:`return float(isinf(x));`,dtype:`bool`})},Bm={kernelName:Ln,backendName:`webgl`,kernelFunc:X({opSnippet:`return float(isnan(x));`,dtype:`bool`})},Vm={kernelName:Un,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a < b);`,packedOpSnippet:`
  return vec4(lessThan(a, b));
`,cpuKernelImpl:$c,dtype:`bool`})},Hm={kernelName:on,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a <= b);`,packedOpSnippet:`
  return vec4(lessThanEqual(a, b));
`,cpuKernelImpl:el,dtype:`bool`})};function Um(e){let{backend:t,attrs:n}=e,{start:r,stop:i,num:a}=n,o=tl(r,i,a);return t.makeTensorInfo([o.length],`float32`,o)}var Wm={kernelName:ai,backendName:`webgl`,kernelFunc:Um},Gm={kernelName:`Log`,backendName:`webgl`,kernelFunc:X({opSnippet:Pu+`
...
`,packedOpSnippet:`
  ...
  return result;
`,cpuKernelImpl:nl})},Km={kernelName:hn,backendName:`webgl`,kernelFunc:X({opSnippet:Pu+`
  return log(1.0 + x);
`})},qm={kernelName:hi,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a >= 1.0 && b >= 1.0);`,packedOpSnippet:`
  return vec4(
    vec4(greaterThanEqual(a, vec4(1.0))) *
    vec4(greaterThanEqual(b, vec4(1.0))));
`,dtype:`bool`})},Jm={kernelName:bt,backendName:`webgl`,kernelFunc:X({opSnippet:`return float(!(x >= 1.0));`})},Ym={kernelName:x,backendName:`webgl`,kernelFunc:Z({opSnippet:`return float(a >= 1.0 || b >= 1.0);`,packedOpSnippet:`
  return min(
    vec4(greaterThanEqual(a, vec4(1.0))) +
    vec4(greaterThanEqual(b, vec4(1.0))),
    vec4(1.0));
`,dtype:`bool`})},Xm=class{constructor(e,t,n,r,i){this.variableNames=[`x`],this.outputShape=[];let a=t,o=e[3]-1;this.outputShape=e;let s,c=`float(${n}) + float(${r}) * sum`;s=i===.5?`inversesqrt(${c})`:i===1?`1.0/(${c})`:`exp(log(${c}) * float(-${i}));`,this.userCode=`
    ...
    `}},eh={kernelName:_r,backendName:`webgl`,kernelFunc:e=>{let{inputs:t,backend:n,attrs:r}=e,{x:i,y:a,dy:o}=t,{depthRadius:s,bias:c,alpha:l,beta:u}=r,d=new $m(i.shape,s,c,l,u);return n.runWebGLProgram(d,[i,a,o],i.dtype)}};function th(e,t,n,r){let i=T(t),a=T(e.shape)/i,o=Q({inputs:{x:e},attrs:{shape:[a,i]},backend:r}),s=qu(o,e.dtype,`max`,r),c=Q({inputs:{x:s},attrs:{shape:n},backend:r});return r.disposeIntermediateTensorInfo(o),r.disposeIntermediateTensorInfo(s),c}function nh(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{reductionIndices:a,keepDims:o}=r,s=i.shape.length,c=F(a,i.shape),l=c,u=D(l,s),d=u!=null,f=n.shouldExecuteOnCPU([i]),p=i;if(d){if(f){let e=n.texData.get(p.dataId).values,t=Array(s);for(let e=0;e<t.length;e++)t[e]=i.shape[u[e]];let r=jl(e,i.shape,i.dtype,u,t);p=n.makeTensorInfo(t,i.dtype);let a=n.texData.get(p.dataId);a.values=r}else p=Zu(i,u,n);l=E(l.length,s)}Le(`max`,l,s);let[m,h]=Lr(p.shape,l),g=m;o&&(g=je(m,c));let _;if(f){let e=n.texData.get(p.dataId).values,t=rl(e,T(h),g,i.dtype);_=n.makeTensorInfo(g,i.dtype);let r=n.texData.get(_.dataId);r.values=t}else _=th(p,h,g,n);return d&&n.disposeIntermediateTensorInfo(p),_}var rh={kernelName:`Max`,backendName:`webgl`,kernelFunc:nh},ih={kernelName:d,backendName:`webgl`,kernelFunc:Z({opSnippet:yu+`
  return max(a, b);
`,packedOpSnippet:`
  ...
  `+xu+`
  return result;
`,cpuKernelImpl:il})};function ah(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t;Pa(i,`maxPool`);let{filterSize:a,strides:o,pad:s,dimRoundingMode:c}=r;A(Dn(o,1),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${o} and dilations '1'`);let l=Zt(i.shape,a,o,1,s,c);if(l.filterWidth===1&&l.filterHeight===1&&O(l.inShape,l.outShape))return Y({inputs:{x:i},backend:n});let u=new Pd(l,`max`,!1);return n.runWebGLProgram(u,[i],i.dtype)}var oh={kernelName:Tt,backendName:`webgl`,kernelFunc:ah};function sh(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{filterSize:a,strides:o,pad:s,dataFormat:c,dimRoundingMode:l}=r,u=new Fd(ut(i.shape,a,o,[1,1,1],s,l,c),`max`,!1);return n.runWebGLProgram(u,[i],i.dtype)}var ch={kernelName:ce,backendName:`webgl`,kernelFunc:sh},lh=class{constructor(e){this.variableNames=[`dy`,`maxPos`],this.outputShape=e.inShape;let t=e.strideHeight,n=e.strideWidth,r=e.dilationHeight,i=e.effectiveFilterHeight,a=e.effectiveFilterWidth,o=i-1-e.padInfo.top,s=a-1-e.padInfo.left,c=i*a-1;this.userCode=`
    ...
    `}};function dh(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,input:a}=t,o=a,{filterSize:s,strides:c,pad:l,dimRoundingMode:u}=r,d=ut(o.shape,s,c,[1,1,1],l,u),f=new Fd(d,`max`,!0),p=n.runWebGLProgram(f,[o],o.dtype),m=new uh(d),h=n.runWebGLProgram(m,[i,p],o.dtype);return n.disposeIntermediateTensorInfo(p),h}var fh={kernelName:te,backendName:`webgl`,kernelFunc:dh};function ph(e){let{inputs:t,backend:n,attrs:r}=e,{dy:i,input:a,output:o}=t,s=a;Pa([a,o],`maxPoolGrad`);let{filterSize:c,strides:l,pad:u,dimRoundingMode:d}=r,f=Zt(s.shape,c,l,1,u,d),p=new Pd(f,`max`,!0),m=n.runWebGLProgram(p,[s],s.dtype),h=new lh(f),g=n.runWebGLProgram(h,[i,m],s.dtype);return n.disposeIntermediateTensorInfo(m),g}var mh={kernelName:nt,backendName:`webgl`,kernelFunc:ph};function hh(e,t,n,r){let i=new Pd(n,`max`,!1),a=r.runWebGLProgram(i,[e],`float32`);return i=new Pd(n,`max`,!0,!0,t),[a,r.runWebGLProgram(i,[e],`float32`)]}var gh={kernelName:cr,backendName:`webgl`,kernelFunc:({inputs:e,attrs:t,backend:n})=>{let{x:r}=e,{filterSize:i,strides:a,pad:o,includeBatchInIndex:s}=t,c=n;A(r.shape.length===4,()=>`Error in maxPool: input must be rank 4 but got rank ${r.shape.length}.`);let l=[1,1];A(Dn(a,l),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${a} and dilations '${l}'`);let[u,d]=hh(r,s,Zt(r.shape,i,a,l,o),c);return[u,d]}};function _h(e,t,n,r){let i=T(t),a=T(e.shape)/i,o=Q({inputs:{x:e},attrs:{shape:[a,i]},backend:r}),s=qu(o,`float32`,`mean`,r),c=Q({inputs:{x:s},attrs:{shape:n},backend:r});return r.disposeIntermediateTensorInfo(o),r.disposeIntermediateTensorInfo(s),c}var vh={kernelName:rr,backendName:`webgl`,kernelFunc:({inputs:e,attrs:t,backend:n})=>{let{x:r}=e,{keepDims:i,axis:a}=t,o=n,s=r.shape.length,c=F(a,r.shape),l=c,u=D(l,s),d=u!=null,f=o.shouldExecuteOnCPU([r]),p=[],m=r;if(d){if(f){let e=o.texData.get(m.dataId).values,t=Array(s);for(let e=0;e<t.length;e++)t[e]=r.shape[u[e]];let n=jl(e,r.shape,r.dtype,u,t);m=o.makeTensorInfo(t,r.dtype);let i=o.texData.get(m.dataId);i.values=n}else m=Zu(r,u,o);p.push(m),l=E(l.length,s)}Le(`sum`,l,s);let[h,g]=Lr(m.shape,l),_=h;i&&(_=je(h,c));let v=_h(m,g,_,o);for(let e of p)o.disposeIntermediateTensorInfo(e);return v}};function yh(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,keepDims:o}=r,s=i.shape.length,c=F(a,i.shape),l=c,u=D(l,s),d=i;u!=null&&(d=$({inputs:{x:i},backend:n,attrs:{perm:u}}),l=E(l.length,i.shape.length)),Le(`min`,l,s);let[f,p]=Lr(d.shape,l),m=T(p),h=Q({inputs:{x:d},backend:n,attrs:{shape:[-1,m]}}),g=qu(h,h.dtype,`min`,n),_;if(o){let e=je(f,c);_=Q({inputs:{x:g},backend:n,attrs:{shape:e}})}else _=Q({inputs:{x:g},backend:n,attrs:{shape:f}});return n.disposeIntermediateTensorInfo(h),n.disposeIntermediateTensorInfo(g),u!=null&&n.disposeIntermediateTensorInfo(d),_}var bh={kernelName:`Min`,backendName:`webgl`,kernelFunc:yh},xh={kernelName:Qe,backendName:`webgl`,kernelFunc:Z({opSnippet:yu+`
  return min(a, b);
`,packedOpSnippet:`
...
`,cpuKernelImpl:al})},Sh=class{constructor(e,t,n){this.variableNames=[`x`],this.outputShape=t.map((t,n)=>t[0]+e[n]+t[1]);let r=e.length,i=U(r),a=t.map(e=>e[0]).join(`,`),o=t.map((t,n)=>t[0]+e[n]).join(`,`),s=[`coords[0]`,`coords[1]`,`coords[2]`,`coords[3]`].slice(0,r),c=n===`reflect`?0:1;if(r===1){this.userCode=`
    ...
    `}},wh={kernelName:st,backendName:`webgl`,kernelFunc:({inputs:e,backend:t,attrs:n})=>{let{x:r}=e,{paddings:i,mode:a}=n,o=N().getBool(`WEBGL_PACK_ARRAY_OPERATIONS`)?new Ch(r.shape,i,a):new Sh(r.shape,i,a);return t.runWebGLProgram(o,[r],r.dtype)}},Th={kernelName:`Mod`,backendName:`webgl`,kernelFunc:Z({opSnippet:`if (b == 0.0) return NAN;
...
return a / b;`,packedOpSnippet:`
  ...
  return result;
`,checkOutOfBounds:!0}),Oh={kernelName:Kr,backendName:`webgl`,kernelFunc:Dh},kh=`return a - b;`,Ah=Z({opSnippet:kh,packedOpSnippet:kh,supportsComplex:!0,cpuKernelImpl:Ol}),jh={kernelName:`Sub`,backendName:`webgl`,kernelFunc:Ah};function Mh(e){let{inputs:t,backend:n,attrs:r}=e,{logits:i}=t,{dim:a}=r,o=F([a],i.shape),s=nh({inputs:{x:i},backend:n,attrs:{reductionIndices:o,keepDims:!1}}),c=je(s.shape,o),l=Q({inputs:{x:s},backend:n,attrs:{shape:c}}),u=Ah({inputs:{a:i,b:l},backend:n}),d=$p({inputs:{x:u},backend:n}),f=$u({inputs:{x:d},backend:n,attrs:{axis:o,keepDims:!1}}),p=Q({inputs:{x:f},backend:n,attrs:{shape:c}}),m=Dh({inputs:{a:d,b:p},backend:n});return n.disposeIntermediateTensorInfo(s),n.disposeIntermediateTensorInfo(l),n.disposeIntermediateTensorInfo(u),n.disposeIntermediateTensorInfo(d),n.disposeIntermediateTensorInfo(f),n.disposeIntermediateTensorInfo(p),m}var Nh={kernelName:v,backendName:`webgl`,kernelFunc:Mh};function Ph(e){let{inputs:t,backend:n,attrs:r}=e,{logits:i}=t,{numSamples:a,seed:o,normalized:s}=r,c=s?i:Mh({inputs:{logits:i},backend:n,attrs:{dim:i.shape.length-1}}),l=c.shape[0],u=c.shape[1],d=new Eh(l,u,a),f=[[o]],p=n.runWebGLProgram(d,[c],`int32`,f);return s||n.disposeIntermediateTensorInfo(c),p}var Fh={kernelName:Te,backendName:`webgl`,kernelFunc:Ph},Ih=J+`
  return -x;
`,Lh=`
  vec4 result = -x;
  bvec4 isNaN = isnan(x);
  ...
  return result;
`;function Rh(e){let{inputs:t,backend:n}=e,{x:r}=t;if(n.shouldExecuteOnCPU([r])){let[e,t]=sl(n.texData.get(r.dataId).values,r.shape,r.dtype);return n.makeTensorInfo(t,r.dtype,e)}let i;return i=N().getBool(`WEBGL_PACK_UNARY_OPERATIONS`)?new iu(r.shape,Lh):new Gl(r.shape,Ih),n.runWebGLProgram(i,[r],r.dtype)}var zh={kernelName:`Neg`,backendName:`webgl`,kernelFunc:Rh},Bh=Rn;function Vh(e){Pe(`tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead`);let{inputs:t,backend:n,attrs:r}=e,{boxes:i,scores:a}=t,{maxOutputSize:o,iouThreshold:s,scoreThreshold:c}=r,{selectedIndices:l}=Bh(n.readSync(i.dataId),n.readSync(a.dataId),o,s,c);return n.makeTensorInfo([l.length],`int32`,new Int32Array(l))}var Hh={kernelName:Ci,backendName:`webgl`,kernelFunc:Vh},Uh=Mr;function Wh(e){Pe(`tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead`);let{inputs:t,backend:n,attrs:r}=e,{boxes:i,scores:a}=t,{maxOutputSize:o,iouThreshold:s,scoreThreshold:c,padToMaxOutputSize:l}=r,{selectedIndices:u,validOutputs:d}=Uh(n.readSync(i.dataId),n.readSync(a.dataId),o,s,c,l);return[n.makeTensorInfo([u.length],`int32`,new Int32Array(u)),n.makeTensorInfo([],`int32`,new Int32Array([d]))]}var Gh={kernelName:g,backendName:`webgl`,kernelFunc:Wh},Kh=vr;function qh(e){Pe(`tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead`);let{inputs:t,backend:n,attrs:r}=e,{boxes:i,scores:a}=t,{maxOutputSize:o,iouThreshold:s,scoreThreshold:c,softNmsSigma:l}=r,{selectedIndices:u,selectedScores:d}=Kh(n.readSync(i.dataId),n.readSync(a.dataId),o,s,c,l);return[n.makeTensorInfo([u.length],`int32`,new Int32Array(u)),n.makeTensorInfo([d.length],`float32`,new Float32Array(d))]}var Jh={kernelName:Mt,backendName:`webgl`,kernelFunc:qh},Yh=class{constructor(e,t,n,r){this.variableNames=[`indices`],this.outputShape=[e,t],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
    ...
    `}},Xh={kernelName:kt,backendName:`webgl`,kernelFunc:e=>{let{inputs:t,backend:n,attrs:r}=e,{indices:i}=t,{dtype:a,depth:o,onValue:s,offValue:c}=r,l=T(i.shape),u=new Yh(l,o,s,c),d=Q({inputs:{x:i},backend:n,attrs:{shape:[l]}}),f=n.runWebGLProgram(u,[d],a);n.disposeIntermediateTensorInfo(d);let p=[...i.shape,o],m=Q({inputs:{x:f},backend:n,attrs:{shape:p}});return n.disposeIntermediateTensorInfo(f),m}};function Zh(e){let{inputs:t,backend:n}=e,{x:r}=t;if(r.dtype===`complex64`){let e=gf({inputs:{input:r},backend:n}),t=Zh({inputs:{x:e},backend:n}),i=Ff({inputs:{input:r},backend:n}),a=Zh({inputs:{x:i},backend:n}),o=wu({inputs:{real:t,imag:a},backend:n});return n.disposeIntermediateTensorInfo(e),n.disposeIntermediateTensorInfo(t),n.disposeIntermediateTensorInfo(i),n.disposeIntermediateTensorInfo(a),o}else return um({attrs:{shape:r.shape,dtype:r.dtype,value:r.dtype===`string`?``:0},backend:n})}var Qh={kernelName:n,backendName:`webgl`,kernelFunc:Zh};function $h(e){let{inputs:t,backend:n}=e,{x:r}=t;if(r.dtype===`string`)throw Error(`onesLike is not supported under string dtype`);if(r.dtype===`complex64`){let e=gf({inputs:{input:r},backend:n}),t=$h({inputs:{x:e},backend:n}),i=Ff({inputs:{input:r},backend:n}),a=Zh({inputs:{x:i},backend:n}),o=wu({inputs:{real:t,imag:a},backend:n});return n.disposeIntermediateTensorInfo(e),n.disposeIntermediateTensorInfo(t),n.disposeIntermediateTensorInfo(i),n.disposeIntermediateTensorInfo(a),o}else return um({attrs:{shape:r.shape,dtype:r.dtype,value:1},backend:n})}var eg={kernelName:It,backendName:`webgl`,kernelFunc:$h};function tg(e){let{inputs:t,backend:n,attrs:r}=e,{axis:i}=r;if(t.length===1)return tm({inputs:{input:t[0]},backend:n,attrs:{dim:i}});let a=t[0].shape,o=t[0].dtype;t.forEach(e=>{Zn(a,e.shape,`All tensors passed to stack must have matching shapes`),A(o===e.dtype,()=>`All tensors passed to stack must have matching dtypes`)});let s=[],c=zf({inputs:t.map(e=>{let t=tm({inputs:{input:e},backend:n,attrs:{dim:i}});return s.push(t),t}),backend:n,attrs:{axis:i}});return s.forEach(e=>n.disposeIntermediateTensorInfo(e)),c}var ng={kernelName:ge,backendName:`webgl`,kernelFunc:tg},rg=class{constructor(e,t,n){this.variableNames=[`x`],this.customUniforms=[{name:`value`,type:`float`}],this.outputShape=t.map((t,n)=>t[0]+e[n]+t[1]);let r=e.length,i=U(r),a=t.map(e=>e[0]).join(`,`),o=t.map((t,n)=>t[0]+e[n]).join(`,`),s=[`coords[0]`,`coords[1]`,`coords[2]`,`coords[3]`].slice(0,r);if(r===1){this.userCode=`
        int start = ${a};
        int end = ${o};
...
`,packedOpSnippet:`
  ...
  `+xu+`
  return result;
`})};function cg(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{axis:a,keepDims:o}=r,s=i.shape.length,c=[],l=F(a,i.shape),u=l,d=D(u,s),f=i;d!=null&&(f=$({inputs:{x:i},backend:n,attrs:{perm:d}}),u=E(u.length,s),c.push(f)),Le(`prod`,u,s);let p;if(n.shouldExecuteOnCPU([f])){let e=n.texData.get(f.dataId).values,{outVals:t,outShape:r,outDtype:i}=ll(f.shape,f.dtype,e,u);p=n.makeTensorInfo(r,i,t)}else{let[e,t]=Lr(f.shape,u),r=T(t),a=Q({inputs:{x:f},backend:n,attrs:{shape:[-1,r]}}),o=qu(a,it(i.dtype),`prod`,n);p=Q({inputs:{x:o},backend:n,attrs:{shape:e}}),c.push(a),c.push(o)}if(o){c.push(p);let e=je(p.shape,l);p=Q({inputs:{x:p},backend:n,attrs:{shape:e}})}return c.forEach(e=>n.disposeIntermediateTensorInfo(e)),p}var lg={kernelName:qt,backendName:`webgl`,kernelFunc:cg};function ug(e){let{inputs:t,backend:n,attrs:r}=e,{paramsNestedSplits:i,paramsDenseValues:a,indices:o}=t,{outputRaggedRank:s}=r,c=i.map(e=>n.readSync(e.dataId)),l=i.map(e=>e.shape),u=n.readSync(a.dataId),d=n.readSync(o.dataId),[f,p,m]=ul(c,l,u,a.shape,a.dtype,d,o.shape,s),h=f.map(e=>n.makeTensorInfo([e.length],`int32`,e)),g=n.makeTensorInfo(m,a.dtype,p);return h.concat([g])}var dg={kernelName:Vt,backendName:`webgl`,kernelFunc:ug};function fg(e){let{inputs:t,backend:n}=e,{starts:r,limits:i,deltas:a}=t,o=n.readSync(r.dataId),s=n.readSync(i.dataId),c=n.readSync(a.dataId),[l,u]=dl(o,r.shape,r.dtype,s,i.shape,c,a.shape);return[n.makeTensorInfo([l.length],`int32`,l),n.makeTensorInfo([u.length],r.dtype,u)]}var pg={kernelName:en,backendName:`webgl`,kernelFunc:fg};function mg(e){let{inputs:t,backend:n,attrs:r}=e,{shape:i,values:a,defaultValue:o,rowPartitionTensors:s}=t,{rowPartitionTypes:c}=r,l=n.readSync(i.dataId),u=n.readSync(a.dataId),d=n.readSync(o.dataId),f=s.map(e=>n.readSync(e.dataId)),p=s.map(e=>e.shape),[m,h]=fl(l,i.shape,u,a.shape,a.dtype,d,o.shape,f,p,c);return n.makeTensorInfo(m,a.dtype,h)}var hg={kernelName:ft,backendName:`webgl`,kernelFunc:mg},gg=e=>{let{backend:t,attrs:n}=e,{start:r,stop:i,step:a,dtype:o}=n,s=pl(r,i,a,o);return t.makeTensorInfo([s.length],o,s)},_g={kernelName:o,backendName:`webgl`,kernelFunc:gg},vg={kernelName:br,backendName:`webgl`,kernelFunc:X({opSnippet:`return 1.0 / x;`})},yg={kernelName:zr,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  return (x < 0.0) ? 0.0 : x;
`,packedOpSnippet:`
  vec4 result = x * vec4(greaterThanEqual(x, vec4(0.0)));
  bvec4 isNaN = isnan(x);
  ...
  return result;
`})},bg={kernelName:Xn,backendName:`webgl`,kernelFunc:X({opSnippet:J+`
  return (x < 0.0) ? 0.0 : min(6.0, x);
`,packedOpSnippet:`
  vec4 result = min(x, vec4(6.)) * vec4(greaterThanEqual(x, vec4(0.0)));
  bvec4 isNaN = isnan(x);
...
`})},xg=class{constructor(e,t,n,r,i){this.variableNames=[`A`],this.outputShape=[];let[a,o,s,c]=e;this.outputShape=[a,t,n,c];let l=[r&&t>1?o-1:o,r&&n>1?s-1:s],u=[r&&t>1?t-1:t,r&&n>1?n-1:n],d;d=i?`(vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC - vec2(0.5)`:`vec2(yRC) * effectiveInputOverOutputRatioRC`,this.userCode=`
    ...
    `}},Bg={kernelName:Cn,backendName:`webgl`,kernelFunc:({inputs:e,attrs:t,backend:n})=>{let{image:r}=e,{radians:i,fillValue:a,center:o}=t,s=n,c=new zg(r.shape,a),[l,u]=f(o,r.shape[1],r.shape[2]),d=[[l,u,Math.sin(i),Math.cos(i)]];return s.runWebGLProgram(c,[r],r.dtype,d)}},Vg={kernelName:Pn,backendName:`webgl`,kernelFunc:X({opSnippet:`
...
`})},Hg={kernelName:kr,backendName:`webgl`,kernelFunc:X({opSnippet:`return inversesqrt(x);`,cpuKernelImpl:ml})},Ug=class{constructor(e,t,n,r,i,a,o=!0,s=!1){this.variableNames=[`updates`,`indices`,`defaultValue`],this.outputShape=a;let c=U(i.length),l=U(a.length),u=``;n===1?u=`i`:n===2&&(u=`i, j`);let d=`getIndices(${u})`,f=``;r===1?f=`i`:r===2&&(f=`i, coords[1]`);let p=`getUpdates(${f})`,m=``;s&&(m=`coords[0], coords[1]`);let h=`getDefaultValue(${m})`;this.userCode=`
      ...
      `}};function Gg(e){let{inputs:t,backend:n,attrs:r}=e,{indices:i,updates:a}=t,{shape:o}=r,{sliceRank:s,numUpdates:c,sliceSize:l,strides:u,outputSize:d}=Ee(a,i,o),f=[d/l,l];if(d===0)return n.makeTensorInfo(o,i.dtype);let p=Q({inputs:{x:i},backend:n,attrs:{shape:[c,s]}}),m=Q({inputs:{x:a},backend:n,attrs:{shape:[c,l]}}),h=n.makeTensorInfo([],`float32`,new Float32Array([0])),g;g=N().getBool(`WEBGL_PACK`)?new Wg(c,s,p.shape.length,m.shape.length,u,f):new Ug(c,s,p.shape.length,m.shape.length,u,f);let _=n.runWebGLProgram(g,[m,p,h],m.dtype),v=Q({inputs:{x:_},backend:n,attrs:{shape:o}});return n.disposeIntermediateTensorInfo(p),n.disposeIntermediateTensorInfo(m),n.disposeIntermediateTensorInfo(_),n.disposeIntermediateTensorInfo(h),v}var Kg={kernelName:hr,backendName:`webgl`,kernelFunc:Gg},qg=class{constructor(e,t,n,r){this.variableNames=[`sortedSequence`,`values`],this.customUniforms=[{name:`numInputs`,type:`int`}],this.outputShape=[e,n];let i=`for (int i = 0; i < ${Math.ceil(Math.log2(t+1))}; ++i) { if (left >= right) break;`;this.userCode=`
    ...
    `}};function Zg(e){let{inputs:t,backend:n}=e,{condition:r,t:i,e:a}=t,o=new Xg(r.shape.length,i.shape,i.shape.length);return n.runWebGLProgram(o,[r,i,a],ue(i.dtype,a.dtype))}var Qg={kernelName:Bn,backendName:`webgl`,kernelFunc:Zg},$g={kernelName:nn,backendName:`webgl`,kernelFunc:X({opSnippet:`
  // Stable and Attracting Fixed Point (0, 1) for Normalized Weights.
  // see: https://arxiv.org/abs/1706.02515
  float scaleAlpha = ${rt};
  float scale = ${Je};
  return (x >= 0.0) ? scale * x : scaleAlpha * (exp(x) - 1.0);
`})},e_={kernelName:ni,backendName:`webgl`,kernelFunc:X({opSnippet:Pu+`
...
`,packedOpSnippet:`
  ...
  return result;
`,cpuKernelImpl:gl})},t_={kernelName:_i,backendName:`webgl`,kernelFunc:X({opSnippet:`
...
`,packedOpSnippet:`
  ...
  ${xu}
  return result;
`})},r_={kernelName:fi,backendName:`webgl`,kernelFunc:X({opSnippet:`
  float e2x = exp(x);
  return (e2x - 1.0 / e2x) / 2.0;
`})},i_={kernelName:ci,backendName:`webgl`,kernelFunc:X({opSnippet:`
  ...
  return result;
`})},a_={kernelName:St,backendName:`webgl`,kernelFunc:e=>{let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{blockShape:a,paddings:o}=r;A(i.shape.length<=4,()=>`spaceToBatchND for rank > 4 with a WebGL backend not implemented yet`);let s=a.reduce((e,t)=>e*t),c=[[0,0]];c.push(...o);for(let e=1+a.length;e<i.shape.length;++e)c.push([0,0]);let l=[],u=ag({inputs:{x:i},backend:n,attrs:{paddings:c,constantValue:0}}),d=Se(u.shape,a,s,!1),f=le(d.length,a.length,!1),p=ze(u.shape,a,s,!1),m=Q({inputs:{x:u},backend:n,attrs:{shape:d}}),h=$({inputs:{x:m},backend:n,attrs:{perm:f}}),g=Q({inputs:{x:h},backend:n,attrs:{shape:p}});return l.push(u),l.push(m),l.push(h),l.forEach(e=>n.disposeIntermediateTensorInfo(e)),g}};function o_(e){let{inputs:t,backend:n}=e,{indices:r,values:i,denseShape:a,defaultValue:o}=t;if(a.shape.length!==1)throw Error(`Dense shape must be a vector, saw:
        ...
        ${o.shape}`);let s=n.readSync(r.dataId),c=n.readSync(i.dataId),l=n.readSync(a.dataId),u=n.readSync(o.dataId)[0],[d,f,p,m,h]=yl(s,r.shape,r.dtype,c,i.dtype,l,u);return[n.makeTensorInfo(f,r.dtype,d),n.makeTensorInfo([f[0]],i.dtype,p),n.makeTensorInfo([m.length],`bool`,new Uint8Array(m.map(e=>Number(e)))),n.makeTensorInfo([h.length],r.dtype,new Int32Array(h))]}var s_={kernelName:ae,backendName:`webgl`,kernelFunc:o_};function c_(e){let{inputs:t,backend:n}=e,{inputIndices:r,inputShape:i,newShape:a}=t;if(r.shape.length!==2)throw Error(`Input indices should be a matrix but received shape ${r.shape}`);if(i.shape.length!==1)throw Error(`Input shape should be a vector but received shape ${i.shape}`);if(a.shape.length!==1)throw Error(`Target shape should be a vector but received shape ${a.shape}`);let o=Array.from(n.readSync(i.dataId)),s=n.readSync(r.dataId),c=Array.from(n.readSync(a.dataId)),[l,u,d]=bl(s,r.shape,r.dtype,o,c);return[n.makeTensorInfo(u,r.dtype,l),n.makeTensorInfo([d.length],a.dtype,new Int32Array(d))]}var l_={kernelName:w,backendName:`webgl`,kernelFunc:c_};function u_(e){let{inputs:t,backend:n}=e,{data:r,indices:i,segmentIds:a}=t;if(r.shape.length<1)throw Error(`Data should be at least 1 dimensional but received scalar`);if(i.shape.length!==1)throw Error(`Indices should be a vector but received shape
              ${i.shape}`);if(a.shape.length!==1)throw Error(`Segment ids should be a vector but received shape
              ${a.shape}`);let o=n.readSync(r.dataId),s=n.readSync(i.dataId),c=n.readSync(a.dataId),[l,u]=xl(o,r.shape,r.dtype,s,c,!0);return n.makeTensorInfo(u,r.dtype,l)}var d_={kernelName:et,backendName:`webgl`,kernelFunc:u_};function f_(e){let{inputs:t,backend:n}=e,{data:r,indices:i,segmentIds:a}=t;if(r.shape.length<1)throw Error(`Data should be at least 1 dimensional but received scalar`);if(i.shape.length!==1)throw Error(`Indices should be a vector but received shape
             ${i.shape}`);if(a.shape.length!==1)throw Error(`Segment ids should be a vector but received shape
             ${a.shape}`);let o=n.readSync(r.dataId),s=n.readSync(i.dataId),c=n.readSync(a.dataId),[l,u]=xl(o,r.shape,r.dtype,s,c);return n.makeTensorInfo(u,r.dtype,l)}var p_={kernelName:ar,backendName:`webgl`,kernelFunc:f_};function m_(e){let{inputs:t,backend:n,attrs:r}=e,{sparseIndices:i,sparseValues:a,defaultValue:o}=t,{outputShape:s}=r,{sliceRank:c,numUpdates:l,sliceSize:u,strides:d,outputSize:f}=Ee(a,i,s);if(a.dtype===`string`){let e=hl(n.bufferSync(i),n.bufferSync(a),s,f,u,l,c,d,bi(n.readSync(o.dataId)[0]),!1);return n.makeTensorInfo(s,e.dtype,e.values)}let p=new Ug(l,c,i.shape.length,a.shape.length,d,[f,1],!1),m=n.runWebGLProgram(p,[a,i,o],a.dtype),h=Q({inputs:{x:m},backend:n,attrs:{shape:s}});return n.disposeIntermediateTensorInfo(m),h}var h_={kernelName:c,backendName:`webgl`,kernelFunc:m_};function g_(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{numOrSizeSplits:a,axis:o}=r,s=F(o,i.shape)[0],c=fn(i,a,s),l=i.shape.length,u=Array(l).fill(0),d=i.shape.slice();return c.map(e=>{let t=[...d];t[s]=e;let r=nf({inputs:{x:i},backend:n,attrs:{begin:u,size:t}});return u[s]+=e,r})}var __={kernelName:tr,backendName:`webgl`,kernelFunc:g_},v_=`return sqrt(x);`,y_={kernelName:Ke,backendName:`webgl`,kernelFunc:X({opSnippet:v_,packedOpSnippet:v_,cpuKernelImpl:Sl})},b_={kernelName:Xe,backendName:`webgl`,kernelFunc:X({opSnippet:`return x * x;`})},x_=`return (a - b) * (a - b);`,S_={kernelName:at,backendName:`webgl`,kernelFunc:Z({opSnippet:x_,packedOpSnippet:x_})};function C_(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t;if(i.dtype!==`string`)throw Error(`Input must be of datatype string`);let a=Cl(Yn(n.readSync(i.dataId)),`string`,r);return n.makeTensorInfo(i.shape,`string`,a)}var w_={kernelName:de,backendName:`webgl`,kernelFunc:C_};function T_({inputs:e,attrs:t,backend:n}){let{x:r}=e,i=J+`
    return x > 0.0 ? 1.0 : float(${t.alpha});
  `,a=new Gl(r.shape,i);return n.runWebGLProgram(a,[r],r.dtype)}var E_={kernelName:Ce,backendName:`webgl`,kernelFunc:T_},D_=class{constructor(e,t,n){this.variableNames=[`x`],this.outputShape=n;let r=n.length,i=U(n.length),a=U(n.length),o=``;if(r===1)o=`coords * strides + begin`;else{let e=0;o=n.map((t,r)=>(e++,n.length===1?`coords * strides[${r}] + begin[${r}]`:`coords[${e-1}] * strides[${r}] + begin[${r}]`)).join(`,`)}this.userCode=`
      ${i} begin = ${i}(${e});
      ${i} strides = ${i}(${t});
    ...
    `}};function O_(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{begin:a,end:o,strides:s,beginMask:c,endMask:l,ellipsisMask:u,newAxisMask:d,shrinkAxisMask:f}=r,{finalShapeSparse:p,finalShape:m,isIdentity:h,sliceDim0:g,isSimpleSlice:_,begin:v,end:y,strides:b}=Yr(i.shape,a,o,s,c,l,u,d,f),x;if(h)x=Q({inputs:{x:i},backend:n,attrs:{shape:m}});else if(g||_){A(i.shape.length>=1,()=>`Input must have rank at least 1, got: ${i.shape.length}`);let e=ct(v,y,b),t=nf({inputs:{x:i},backend:n,attrs:{begin:v,size:e}});x=Q({inputs:{x:t},backend:n,attrs:{shape:m}}),n.disposeIntermediateTensorInfo(t)}else if(n.shouldExecuteOnCPU([i])){let e=n.readSync(i.dataId),t=wl(p,P(i.shape,i.dtype,e),b,v);x=n.makeTensorInfo(m,i.dtype,t.values)}else{let e=new D_(v,b,p);x=n.runWebGLProgram(e,[i],i.dtype)}let S=Q({inputs:{x},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(x),S}var k_={kernelName:Ve,backendName:`webgl`,kernelFunc:O_};function A_(e){let{inputs:t,backend:n,attrs:r}=e,{separator:i,nGramWidths:a,leftPad:o,rightPad:s,padWidth:c,preserveShortSequences:l}=r,{data:u,dataSplits:d}=t,[f,p]=Tl(n.readSync(u.dataId),n.readSync(d.dataId),i,a,o,s,c,l);return[n.makeTensorInfo([f.length],`string`,f),n.makeTensorInfo(d.shape,`int32`,p)]}var j_={kernelName:ht,backendName:`webgl`,kernelFunc:A_};function M_(e){let{inputs:t,backend:n,attrs:r}=e,{skipEmpty:i}=r,{input:a,delimiter:o}=t;if(a.dtype!==`string`)throw Error(`Input must be of datatype string`);if(a.shape.length!==1)throw Error(`Input must be a vector, got shape: ${a.shape}`);if(o.shape.length!==0)throw Error(`Delimiter must be a scalar, got shape: ${o.shape}`);let s=n.readSync(a.dataId),c=n.readSync(o.dataId)[0],[l,u,d]=El(s,c,i),f=u.length;return[n.makeTensorInfo([f,2],`int32`,l),n.makeTensorInfo([f],`string`,u),n.makeTensorInfo([2],`int32`,new Int32Array(d))]}var N_={kernelName:xi,backendName:`webgl`,kernelFunc:M_};function P_(e){let{inputs:t,backend:n,attrs:r}=e,{numBuckets:i}=r,{input:a}=t;if(a.dtype!==`string`)throw Error(`Input must be of datatype string`);if(i<=0)throw Error(`Number of buckets must be at least 1`);let o=Dl(n.readSync(a.dataId),i);return n.makeTensorInfo(a.shape,`int32`,o)}var F_={kernelName:m,backendName:`webgl`,kernelFunc:P_},I_={kernelName:`Tan`,backendName:`webgl`,kernelFunc:X({opSnippet:`return tan(x);`})},L_={kernelName:Ft,backendName:`webgl`,kernelFunc:X({opSnippet:`
  float e2x = exp(-2.0 * abs(x));
  return sign(x) * (1.0 - e2x) / (1.0 + e2x);
`})};function R_(e){let{inputs:t,backend:n,attrs:r}=e,{tensor:i,indices:a,updates:o}=t,{}=r,{sliceRank:s,numUpdates:c,sliceSize:l,strides:u,outputSize:d}=Ee(o,a,i.shape),f=[d/l,l];if(d===0)return n.makeTensorInfo(i.shape,a.dtype);let p=Q({inputs:{x:a},backend:n,attrs:{shape:[c,s]}}),m=Q({inputs:{x:o},backend:n,attrs:{shape:[c,l]}}),h=Q({inputs:{x:i},backend:n,attrs:{shape:f}}),g=new Ug(c,s,p.shape.length,m.shape.length,u,f,!1,!0),_=n.runWebGLProgram(g,[m,p,h],h.dtype),v=Q({inputs:{x:_},backend:n,attrs:{shape:i.shape}});return n.disposeIntermediateTensorInfo(p),n.disposeIntermediateTensorInfo(m),n.disposeIntermediateTensorInfo(h),n.disposeIntermediateTensorInfo(_),v}var z_={kernelName:he,backendName:`webgl`,kernelFunc:R_},B_=class{constructor(e,t){this.variableNames=[`A`];let n=Array(e.length);for(let r=0;r<n.length;r++)n[r]=e[r]*t[r];this.outputShape=n,this.rank=n.length,this.userCode=`
      void main() {
        ${U(this.rank)} resRC = getOutputCoords();
        setOutput(getA(${V_(e)}));
      }
    `}};function V_(e){let t=e.length;if(t>5)throw Error(`Tile for rank ${t} is not yet supported`);if(t===1)return`imod(resRC, ${e[0]})`;let n=[`resRC.x`,`resRC.y`,`resRC.z`,`resRC.w`,`resRC.u`],r=[];for(let t=0;t<e.length;t++)r.push(`imod(${n[t]}, ${e[t]})`);return r.join()}function H_(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{reps:a}=r;if(i.dtype===`string`||i.shape.length>5){let e=n.readSync(i.dataId),t=i.dtype===`string`?e.map(e=>bi(e)):e,r=kl(P(i.shape,i.dtype,t),a);return n.makeTensorInfo(r.shape,r.dtype,r.values)}let o=new B_(i.shape,a);return n.runWebGLProgram(o,[i],i.dtype)}var U_={kernelName:Fe,backendName:`webgl`,kernelFunc:H_},W_=class{constructor(e){this.variableNames=[`x`,`indices`],this.customUniforms=[{name:`n`,type:`int`},{name:`firstPass`,type:`int`},{name:`negativeInf`,type:`float`},{name:`dir`,type:`int`},{name:`inc`,type:`int`}],this.outputShape=e,this.userCode=`
       void main() {
         ivec2 coords = getOutputCoords();
         int batch = coords[0];
    ...
    void main() {
     ...
     `}};function K_(e,t){t!==null&&e.disposeIntermediateTensorInfo(t)}function q_(e){let t=1;for(;t<e;)t*=2;return t}function J_(e){let{inputs:t,backend:n,attrs:r}=e,{x:i}=t,{k:a,sorted:o}=r,s=N().getNumber(`TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD`),c=N().getNumber(`TOPK_K_CPU_HANDOFF_THRESHOLD`),l=i.shape,u=l[l.length-1];if(n.shouldExecuteOnCPU([i])||u<s||a>c){let[e,t]=Al(n.readSync(i.dataId),l,i.dtype,a,o);return[n.makeTensorInfo(e.shape,e.dtype,e.values),n.makeTensorInfo(t.shape,t.dtype,t.values)]}if(a===0)return l[l.length-1]=0,[n.makeTensorInfo(l,i.dtype,[]),n.makeTensorInfo(l,`int32`,[])];if(u===1)return[i,um({attrs:{shape:l,dtype:`int32`,value:0},backend:n})];let d=n.texData.get(i.dataId),f=d!==null&&d.isPacked,p=f?n.unpackTensor(i):i,m=T(l)/u,h=Q({inputs:{x:p},attrs:{shape:[m,u]},backend:n});f&&K_(n,p);let g=q_(a),_=q_(u),v=null,y=()=>v===null?[h,h]:[h,v],b=(e,t,r)=>{let i=y(),a=new W_(r),o=[[u],[v===null?1:0],[-1/0],[e],[t]],s=v;v=n.runWebGLProgram(a,i,`int32`,o),K_(n,s)};for(let e=1;e<g;e*=2){let t=e*2;for(let n=e;n>=1;n/=2)b(t,n,[m,_])}for(let e=_;e>g;e/=2){let t=y(),r=new G_([m,e/2]),i=[[u],[v===null?1:0],[g]],a=v;v=n.runWebGLProgram(r,t,`int32`,i),K_(n,a);let o=g/2,s=o*2;for(let e=o;e>=1;e/=2)b(s,e,v.shape)}let x=v;v=nf({inputs:{x:v},backend:n,attrs:{begin:0,size:[m,a]}}),K_(n,x);let S=Mm({inputs:{x:h,indices:v},backend:n,attrs:{axis:1,batchDims:1}});K_(n,h);let C=l.slice(0,-1);C.push(a),x=v,v=Q({inputs:{x:v},attrs:{shape:C},backend:n}),K_(n,x);let w=S;return S=Q({inputs:{x:S},attrs:{shape:C},backend:n}),K_(n,w),[S,v]}var Y_={kernelName:Pr,backendName:`webgl`,kernelFunc:J_},X_=class{constructor(e,t,n,r,i,a){this.variableNames=[`Image`,`Transforms`],this.outputShape=a;let o=n===`nearest`?1:2,s;switch(r){case`constant`:s=1;break;case`reflect`:s=2;break;case`wrap`:s=3;break;case`nearest`:s=4;break;default:s=1;break}this.userCode=`
        ...
        `}};function Z_(e){let{inputs:t,backend:n,attrs:r}=e,{image:i,transforms:a}=t,{interpolation:o,fillMode:s,fillValue:c,outputShape:l}=r,[u,d,f,p]=i.shape,[m,h]=l??[d,f],g=new X_(d,f,o,s,c,[u,m,h,p]);return n.runWebGLProgram(g,[i,a],`float32`)}var Q_={kernelName:ke,backendName:`webgl`,kernelFunc:Z_};function $_(e){let{inputs:t,attrs:n,backend:r}=e,{axis:i}=n,{x:a}=t;Pa(a,`unique`),console.warn(`WARNING: `,`UI might be locked temporarily as data is being downloaded`);let{outputValues:o,outputShape:s,indices:c}=Ml(r.readSync(a.dataId),i,a.shape,a.dtype);return[r.makeTensorInfo(s,a.dtype,o),r.makeTensorInfo([c.length],`int32`,c)]}var ev={kernelName:Rt,backendName:`webgl`,kernelFunc:$_};function tv(e){let{inputs:t,backend:n,attrs:r}=e,{value:i}=t,{axis:a}=r;a<0&&(a+=i.shape.length);let o=i,s=o.shape.length,c=i.shape[a],l=Array(s-1),u=0;for(let e=0;e<s;e++)e!==a&&(l[u++]=o.shape[e]);let d=[],f=Array(s).fill(0),p=o.shape.slice();p[a]=1;let m=Array(c);for(let e=0;e<m.length;e++){f[a]=e;let t=nf({inputs:{x:o},backend:n,attrs:{begin:f,size:p}});m[e]=Q({inputs:{x:t},backend:n,attrs:{shape:l}}),d.push(t)}return d.forEach(e=>n.disposeIntermediateTensorInfo(e)),m}var nv={kernelName:Xt,backendName:`webgl`,kernelFunc:tv},rv=class{constructor(e,t){this.variableNames=[`x`,`segmentIds`];let n=e.windowSize,r=e.batchSize,i=e.inSize,a=e.numSegments;this.outputShape=[r,a*Math.ceil(i/n)];let o=Math.floor(n/4)*4,s=n%4,c=`
    ...
    `}};function iv(e){let{inputs:t,backend:n,attrs:r}=e,{x:i,segmentIds:a}=t,{numSegments:o}=r,s=i.shape.length,c=[],l=0,u=D([l],s),d=i;u!=null&&(d=$({inputs:{x:i},backend:n,attrs:{perm:u}}),c.push(d),l=E(1,s)[0]);let f=wr(d.shape,l,o),p=T([d.shape[l]]),m=Q({inputs:{x:d},backend:n,attrs:{shape:[-1,p]}});c.push(m);let h=it(i.dtype),g=(e,t,r,i,a)=>{let o=e.shape[0],s=e.shape[1],l=Hr(s,a),u=new rv({windowSize:l,inSize:s,batchSize:o,numSegments:a},t),d=n.compileAndRun(u,[e,r],i);if(c.push(d),d.shape[1]===a)return d;let f=gg({backend:n,attrs:{start:0,stop:a,step:1,dtype:`float32`}}),p=H_({inputs:{x:f},backend:n,attrs:{reps:[s/l]}});return c.push(f),c.push(p),g(d,t,p,i,a)},_=Q({inputs:{x:g(m,`unsortedSegmentSum`,a,h,o)},backend:n,attrs:{shape:f}}),v=_;if(u!=null){c.push(_);let e=$t(u);v=$({inputs:{x:v},backend:n,attrs:{perm:e}})}return c.forEach(e=>n.disposeIntermediateTensorInfo(e)),v}var av=[id,sd,cd,ld,dd,hd,_d,yd,Ed,Od,kd,Ad,jd,Md,Nd,Ld,zd,Ud,Gd,qd,Xd,af,sf,df,pf,xf,Cf,Df,Tu,jf,Bf,Yf,tp,ip,op,cp,up,dp,fp,mp,xp,Cp,Tp,Op,Mp,Ip,Rp,Vp,Wp,Kp,qp,Xp,Zp,Qp,em,nm,im,cm,dm,pm,hm,gm,ym,wm,Em,km,Nm,Pm,Fm,Cu,Lm,If,Rm,zm,Bm,ku,Vm,Hm,Wm,Gm,Km,qm,Jm,Ym,Qm,eh,rh,ih,oh,ch,fh,mh,gh,vh,bh,xh,wh,Th,Fh,Vu,zh,Hh,Gh,Jh,hf,Xh,eg,ng,og,sg,Nu,lg,dg,pg,hg,_g,_f,Oh,vg,yg,bg,Uu,wg,Dg,jg,Pg,Rg,Bg,Vg,Hg,Kg,Yg,Qg,$g,e_,t_,n_,r_,rf,Nh,i_,a_,s_,l_,d_,p_,h_,__,y_,b_,S_,w_,E_,k_,j_,N_,F_,jh,ed,I_,L_,z_,U_,Y_,Q_,td,ev,nv,{kernelName:lt,backendName:`webgl`,kernelFunc:iv},Qh];for(let e of av)me(e);export{hs as GPGPUContext,mu as MathBackendWebGL,_u as forceHalfFloat,Ko as gpgpu_util,Ei as setWebGLContext,gu as version_webgl,vu as webgl,Ii as webgl_util};