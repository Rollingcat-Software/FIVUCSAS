...
The enrollment and verification surfaces are supported by the activity flows captured in [[FIG:face_enroll_quality | Face enrollment with quality assessment]] and [[FIG:face_verify_liveness | Face verification with liveness]], and the end-user registration flow in [[FIG:seq_registration | User registration sequence]].
