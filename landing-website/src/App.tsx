...
const t = {
  ...
  architecture: {
    ...
    nodes: {
      ...
      traefik:   { en: 'Traefik · TLS · routing', tr: 'Traefik · TLS · yönlendirme' },
      ...
      postgres:  { en: 'PostgreSQL + pgvector', tr: 'PostgreSQL + pgvector' },
      redis:     { en: 'Redis · cache · sessions', tr: 'Redis · önbellek · oturum' },
    },
  },
  services: {
    ...
    items: [
      ...
      { icon: 'eye', name: 'Biometric Processor',
        description: { en: 'ML-powered face and voice recognition engine. 70+ endpoints for enrollment, verification, and anti-spoofing.', tr: 'ML destekli yüz ve ses tanıma motoru. Kayıt, doğrulama ve spoof önleme için 70+ uç nokta.' },
        tech: ['FastAPI', 'Python 3.12', 'DeepFace', 'pgvector'] },
          ...
          <div className="flex items-center justify-between h-16">
            <a href="#hero" className="flex items-center gap-3 group" aria-label="FIVUCSAS home">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span lang="en" className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">identity · verified</span>
              </div>
            </a>
          ...
          <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative max-w-6xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a
                  href="https://amispoof.fivucsas.com/" target="_blank" rel="noopener noreferrer"
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-5 text-sm text-slate-400">
              ...
              <a href="https://github.com/Rollingcat-Software/spoof-detector" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-1.5">
                <Icon name="github" className="w-4 h-4" fill /> spoof-detector
              </a>
              <a href="https://github.com/Rollingcat-Software/FIVUCSAS" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors inline-flex items-center gap-1.5">
                <Icon name="github" className="w-4 h-4" fill /> FIVUCSAS
              </a>
            </div>
